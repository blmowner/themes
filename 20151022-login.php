        ...
        <div class="banner_right">
            <div class="banner_rightContent">
                ...
                <div id="login">
                    ...
                    ?>
                    <form method="post">
                        <input type="text" name="username" placeholder="User ID" required data-errormessage-value-missing="Please Enter User Id"/>
                        <input type="password" name="password" placeholder="Password" required data-errormessage-value-missing="Please Enter Password"/>
