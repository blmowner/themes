...
<body onload="showLink('1')" style = "height: 82%;">
<div id="idletimeout">
			...
			$dbg->f("role_id");	
                ...
                do {
				   ...
				   if($db->f("text")=='Home' && $dbg->f("role_id")!='20150410001')
					{
						echo "<li><a href=\"control_panel/announcement/announcement.php\" target=\"main\" onclick=\"showLink(".$db->f("menu_id")."); changeClass(this);\">".$db->f("text").""; 	
					}
...
echo "<li><a href=\"control_panel/announcement/announcement.php\" target=\"main\" onclick=\"showLink(".$db->f("menu_id")."); changeClass(this);\">".$db->f("text")."";
    ...
    <div id="content"><!-- content -->
        ...
        <iframe style="background: #FFFFFF; padding-top:5px;" src="#" name="main" id="main" width="100%" height="95%" marginheight="0" marginwidth="0" frameborder="0"></iframe>
