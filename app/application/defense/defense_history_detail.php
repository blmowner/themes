...
// Program Name: defense_history_detail.php
//
// Created by: Zuraimi
		...
		<form id="form1" name="form1" method="post" enctype="multipart/form-data">
			<fieldset>
				...
				<?  
					...
					ORDER BY b.pg_employee_empid, b.responded_date DESC";
					...
					<tr>
						...
						<th width="35%" align="left"><strong>Thesis/Project</strong></th>
						<th width="10%" align="left"><strong>Student Status</strong></th>	
						<th width="15%" align="left"><strong>Supervisor / Co-Supervisor</strong></th>
						...
						<th width="5%"><strong>Record Status</strong></th>						
					</tr>
					<?
					...
					?>
						<tr>
							...
							<?
							if (substr($employeeId[$i],0,3) != 'S07') {
								$dbConn = $dbc;
							}
							else {
								$dbConn = $dbc1;
							...
							WHERE b.empid= '$employeeId[$i]'";
								
							$result_sql_employee = $dbConn->query($sql_employee);
							$dbConn->next_record();
							
							$employeeName = $dbConn->f('name');
							?>
							<td><label><?=$employeeName?><br/>(<?=$employeeId[$i]?>)</label></td>
					...
					?>					
					  ...
					  <table>
						<tr>
							<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../defense/defense_history.php';" /></td>
						</tr>
					</table>
					<?
