...
// Program Name: defense_view_feedback_staff.php
//
// Created by: Zuraimi
...
d.ref_session_type_id, e.description as session_type_desc,
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function respConfirm () {
		...
		<table>
			<tr>
				<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../defense/review_defense_detail.php?pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&id=<?=$defenseId;?>&mn=<?=$studentMatrixNo;?>&ref=<?=$referenceNo;?>&cid=<?=$calendarId?>';" /></td>
			</tr>
		</table>
		</br>
		</form>
