...
// Program Name: defense_view_report_history_staff.php
//
// Created by: Zuraimi
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function respConfirm () {
		...
		<table>
			<tr>
				<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../defense/view_defense_history_staff.php?pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&id=<?=$defenseId;?>&pdid=<?=$defenseDetailId;?>&mn=<?=$studentMatrixNo;?>&ref=<?=$referenceNo;?>';" /></td>
			</tr>
		</table>
		</br>
		</form>
