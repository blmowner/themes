...
// Program Name: new_defense_publication.php
//
// Created by: Zuraimi
...
if(isset($_POST['btnAdd']) && ($_POST['btnAdd'] <> ""))
{
	...
	if(empty($msg)) 
	{
		...
		if ($defense_id!="") { 
			...
			STR_TO_DATE('$myAddPublishedDate','%d-%M-%Y'), '$myAddPublicationTitle', 'DEF', '$myAddPublicationId', '$addPublicationTypeId',
...
?>
  ...
  <form id="form1" name="form1" method="post" enctype="multipart/form-data" onsubmit="return saveRec();">
	 ...
	 <fieldset>
		...
		<table>
			<tr>
				<td><a class='select_publication' href="../../application/defense/select_publication.php">[Select From Manage Publication]</a></td>
			</tr>
		</table>
		<table>
			<tr>
			...
			<tr>
				...
				<input name="add_publication_type_id" type="hidden" id="add_publication_type_id" size="50" value="<?=$_POST['add_publication_type_id']?>">
			</tr>
			<tr>
