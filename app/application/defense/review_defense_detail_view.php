...
// Program Name: review_defense_detail_view.php
//
// Created by: Zuraimi
...
AND d.pg_employee_empid = '$user_id'
					...
					do {
						...
						<tr class="<?=$color?>">
							...
							if ($defenseDetailStatus != '') {
								?><td><a href="defense_view_feedback.php?tid=<?=$thesisId;?>&pid=<?=$proposalId;?>&eid=<?=$employeeId;?>&id=<?=$id;?>&ref=<?=$referenceNo;?>&mn=<?=$studentMatrixNo?>&cid=<?=$defenseCalendarId?>" name="thesisId" value="<?=$thesisId?>"><?=$defenseDetailDesc;?></a></td>	
							<?}
							else {
								?><td><a href="defense_view_feedback.php?tid=<?=$thesisId;?>&pid=<?=$proposalId;?>&eid=<?=$employeeId;?>&id=<?=$id;?>&ref=<?=$referenceNo;?>&mn=<?=$studentMatrixNo?>&cid=<?=$defenseCalendarId?>" name="thesisId" value="<?=$thesisId?>">Expecting Defense Proposal</a></td>	
								<?
							}
							?>
