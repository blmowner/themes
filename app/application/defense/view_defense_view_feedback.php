...
// Program Name: view_defense_view_feedback.php
//
// Created by: Zuraimi
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function respConfirm () {
		...
		<table>
			<tr>
				<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../defense/view_defense.php?pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&id=<?=$defenseId;?>&ref=<?=$referenceNo;?>&cid=<?=$calendarId?>';" /></td>
			</tr>
		</table>
		</br>
		</form>
