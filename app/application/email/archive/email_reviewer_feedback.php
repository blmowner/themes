	...
	$messageBody = "<div>
					  <div><span color=\"#837E7E\" size=\"-1\" face=\"Trebuchet MS, Arial, Helvetica, sans-serif\" data-mce-style=\"color: #837e7e; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;\">
						...
						<font face=\"Verdana, Arial, Helvetica, sans-serif\">														
							<br>Dear ".$title." ".$facultyname.",
							<br><p>Please be informed, the following staff has accepted of the offer of appointment to serve as a ".$position." for the
					...
					<table>
						<tr>
						  ...
						  <td bgcolor=\"#DBDBDB\"><font face=\"Verdana, Arial, Helvetica, sans-serif\">".$reviewertitle." ".$reviewername."</font></td>
						  </tr>
						<tr>
