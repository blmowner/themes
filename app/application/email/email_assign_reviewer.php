<?php
	...
	// from
	$headers .= "From: \"" . $admin . "\" <" . $fromadmin . ">\r\n"; //from faculty>>>>>>> $username , $useremail

	if($manage == 'GSM')
	{
		$headers .= 'Cc: ridxvin11@gmail.com' . "\r\n";///>>>>>> email faculty group $email2[1]
		
	}
	else if($manage == 'SGS')
	{
		$headers .= 'Cc: ridxvin11@gmail.com' . "\r\n";///>>>>>> email faculty group $email2[2]
	}
	else
	{
	...
	$messageBody = "<div>
					  <div><span color=\"#837E7E\" size=\"2\" face=\"Trebuchet MS, Arial, Helvetica, sans-serif\" data-mce-style=\"color: #837e7e; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;\">
						...
						<tr>
							<td>
							<font face=\"Verdana, Arial, Helvetica, sans-serif\" size=\"2\">\r\nPlease be informed, the following student has submitted his/her thesis proposal for our approval. We would like to extend an invitation to you to serve as a ".$position." for the PhD thesis of the following candidate.</font>
							</td>
						 </tr><div></div>
						 <tr>
							<td>&nbsp;</td>
						...
						<tr>
						  ...
						  <td bgcolor=\"#5B74A8\"><strong><font color=\"#FFFFFF\" face=\"Verdana, Arial, Helvetica, sans-serif\" size=\"2\">Student Name </font></strong></td>
						  <td bgcolor=\"#DBDBDB\"><font face=\"Verdana, Arial, Helvetica, sans-serif\" size=\"2\">".$studidname."</font></td>
						  </tr>
						<tr>
						...
						<tr>
						  ...
						  <td bgcolor=\"#DBDBDB\"><font face=\"Verdana, Arial, Helvetica, sans-serif\" size=\"2\">".mysql_real_escape_string($thesisTitle)."</font></td>
						</tr>
						<tr>
	...
	mail('mohd_nizam@msu.edu.my', $subject, $message, $headers); ///$empEmail[$val]l
?>