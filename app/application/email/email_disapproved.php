<?php
	...
	// from
	$headers .= "From: \"" . $admin . "\" <" . $fromadmin. ">\r\n";/////faculty //from faculty>>>>>>> $facultyname ,  $facultyemail
	...
	$messageBody = "<div>
					  <div><span color=\"#837E7E\" size=\"-1\" face=\"Trebuchet MS, Arial, Helvetica, sans-serif\" data-mce-style=\"color: #837e7e; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;\">
						...
						<tr>
						  ...
						  <td bgcolor=\"#DBDBDB\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">".$insertBy."</font></td>
						  </tr>
						<tr>
						...
						<tr>
						  <td bgcolor=\"#5B74A8\"><strong><font size=\"2\" color=\"#FFFFFF\" face=\"Verdana, Arial, Helvetica, sans-serif\">Thesis/Project Title </font></strong></td>
	...
	$ok = mail('mohd_nizam@msu.edu.my', $subject, $message, $headers); ////>>>>>> $studemail
