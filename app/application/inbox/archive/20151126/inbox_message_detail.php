	...
	<table>
		...
		<tr>			
			...
			<tr>
			  ...
			  <td bgcolor="#DBDBDB"><div style="background-color:#FFFFFF;margin:10px;"><?=$theMessage?></div><!--<textarea name="message" id="message" cols="50" class = "ckeditor" rows="8"></textarea>--></td>

		</tr>
			<tr>
			  <td bgcolor="#5B74A8"><span class="style3"><font color="#FFFFFF">Attachment</font></span></td>
		<?php 
    	$sql_file = "SELECT * FROM file_upload_inbox 
		...
		{	?> <td> <?
		 ...
		 ?>
			  ...
			  <a href="download.php?id=<?=$fu_cd;?>" target="_blank"><?php echo $namefile ?>
