...
//$user_id=$_SESSION['user_id'];
	...
	$message = "<div>
					  <div><span color=\"#837E7E\" size=\"-1\" face=\"Trebuchet MS, Arial, Helvetica, sans-serif\" data-mce-style=\"color: #837e7e; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;\">
						...
						<table>
						 ...
						 <div></div>
						<tr>
							<td><font face=\"Verdana, Arial, Helvetica, sans-serif\">\r\nDear ".mysql_real_escape_string($title)." ".$supername.",\r\n\n</font><td>
						</tr>
						 <div></div>
						<tr>
							<td>
						...
						<tr>
						  <td bgcolor=\"#5B74A8\"><strong><font color=\"#FFFFFF\" face=\"Verdana, Arial, Helvetica, sans-serif\">Thesis Type </font></strong></td>
						  <td bgcolor=\"#DBDBDB\"><font face=\"Verdana, Arial, Helvetica, sans-serif\">".$typedesc."</font></td>
						</tr>
						  </table>
						<div><br />
					  </div>
	...
	VALUES('$newMessageDetailId','$newMessageId', '$superid', 'NEW', '$curdatetime', 'NEW', '$curdatetime')";
	$dbf->query($sq2);
