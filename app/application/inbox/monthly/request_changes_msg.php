...
//$user_id=$_SESSION['user_id'];
	...
	$superName = preg_replace('/[^\p{L}\p{N}\s]/u', '', $superName);
	$studname= preg_replace('/[^\p{L}\p{N}\s]/u', '', $studname);
	$subject = "Monthly Progress Report Submitted by ".$studname." - Reviewed by ".$superName."";
	...
	$message = "<div>
					  <div><span color=\"#837E7E\" size=\"-1\" face=\"Trebuchet MS, Arial, Helvetica, sans-serif\" data-mce-style=\"color: #837e7e; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;\">
						...
						<tr>
						  ...
						  <td bgcolor=\"#DBDBDB\"><font face=\"Verdana, Arial, Helvetica, sans-serif\">".$title."</font></td>
						  </tr>
						  <tr>
						  <td bgcolor=\"#5B74A8\"><strong><font color=\"#FFFFFF\" face=\"Verdana, Arial, Helvetica, sans-serif\">Month </font></strong></td>
						  <td bgcolor=\"#DBDBDB\"><font face=\"Verdana, Arial, Helvetica, sans-serif\">".$month." ".$year."</font></td>
						  </tr>
						<tr>
						...
						<tr>
						  ...
						  <td bgcolor=\"#DBDBDB\"><font face=\"Verdana, Arial, Helvetica, sans-serif\">Request Changes</font></td>
						</tr>
					  ...
					  <div><br><font face=\"Verdana, Arial, Helvetica, sans-serif\">".$superName."</font><br /></div>
					  <div><br />
						<center>
						  <div><br /></div>
						  <hr noshade=\"noshade\" size=\"1\" />
	...
	VALUES('$newMessageDetailId','$newMessageId', '$studentMatrixNo', 'NEW', '$curdatetime', 'NEW', '$curdatetime')";
	$dbf->query($sq2);
