...
function convertid($staff_id)
{
	...
	$message = "<div>
					  <div><span color=\"#837E7E\" size=\"-1\" face=\"Trebuchet MS, Arial, Helvetica, sans-serif\" data-mce-style=\"color: #837e7e; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;\">
						...
						<tr>
						  <td bgcolor=\"#5B74A8\"><strong><font color=\"#FFFFFF\" face=\"Verdana, Arial, Helvetica, sans-serif\">Thesis/Project Title </font></strong></td>
	...
	do{		
		...
		VALUES('$newMessageDetailId','$newMessageId', '$myStudentId[$val]', 'NEW', '$curdatetime', 'NEW', '$curdatetime')";
		$dbf->query($sq2);
