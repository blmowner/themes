...
//$user_id=$_SESSION['user_id'];
					  ...
					  <div><span color=\"#837E7E\" size=\"-1\" face=\"Trebuchet MS, Arial, Helvetica, sans-serif\" data-mce-style=\"color: #837e7e; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;\">
						<center>
						  ...
						  <hr noshade=\"noshade\" size=\"1\" />
							...
							Phd Candidate, ".$studname."(Matric No: ".$studid[$val].") as mentioned in the invitation email dated ".$senatedate[$val]." .</font></br>
							<br>
	...
	$newMessageDetailId = runnum5('id','pg_messages_detail');
	...
	foreach($facuId as $allempid)
	{
		...
		VALUES('$newMessageDetailId','$newMessageId', '$allempid', 'NEW', '$curdatetime', 'NEW', '$curdatetime')";
		$dbf->query($sq2);
	} 
