...
//$user_id=$_SESSION['user_id'];
	...
	$subject = "Appeal on Thesis Submitted by ".$studentName." Result";
	...
	$message = "<div>
					  <div><span color=\"#837E7E\" size=\"-1\" face=\"Trebuchet MS, Arial, Helvetica, sans-serif\" data-mce-style=\"color: #837e7e; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;\">
						...
						<tr>
							<td><font face=\"Verdana, Arial, Helvetica, sans-serif\">
							\r\nThe appeal on thesis result as follows :-.\r\n\n</font></td>
						 </tr>
						 <tr>
							<td>&nbsp;</td>
						 </tr>
						...
						<tr>
						 ...
						 <tr>
						  <td bgcolor=\"#5B74A8\"><strong><font color=\"#FFFFFF\" face=\"Verdana, Arial, Helvetica, sans-serif\">Result Status </font></strong></td>
						  <td bgcolor=\"#DBDBDB\"><font face=\"Verdana, Arial, Helvetica, sans-serif\">Disapproved</font></td>
						 </tr>
	...
	$sq2="INSERT INTO pg_messages_detail
		...
		VALUES('$newMessageDetailId','$newMessageId', '$spMain', 'NEW', '$curdatetime', 'NEW', '$curdatetime')";
	$dbf->query($sq2);
