...
//$user_id=$_SESSION['user_id'];
	...
	$subject = "Work Completion Submitted by ".$studentName." ";
	...
	$message = "<div>
					  <div><span color=\"#837E7E\" size=\"-1\" face=\"Trebuchet MS, Arial, Helvetica, sans-serif\" data-mce-style=\"color: #837e7e; font-family: Trebuchet MS,Arial,Helvetica,sans-serif;\">
						...
						<tr>
							<td><font face=\"Verdana, Arial, Helvetica, sans-serif\">
							\r\nSubmitted work completion as follows :-.\r\n\n</font></td>
						 </tr>
						 <tr>
							<td>&nbsp;</td>
						 </tr>
	...
	$sq2="INSERT INTO pg_messages_detail
		...
		VALUES('$newMessageDetailId','$newMessageId', '$examinerIdArray[$j]', 'NEW', '$curdatetime', 'NEW', '$curdatetime')";
	$dbf->query($sq2);
