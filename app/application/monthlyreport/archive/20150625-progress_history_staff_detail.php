			...
			<fieldset>
				...
				<?  
					...
					<tr>
						...
						<th><strong>Report Reference No.</strong></th>						
						<th><strong>Student Status</strong></th>	
						<th><strong>Supervisor Status</strong></th>	
						<th><strong>Archived Status</strong></th>						
					</tr>
					<?
					...
					?>
						<tr>
							...
							<td><label><a href="../monthlyreport/progress_history_outline_staff.php?pid=<?=$proposalId;?>&mn=<?=$studentMatrixNo?>"><?=$thesisId?></a></label></td>
							<td><label><?=$thesisTitle?></label></td>
							<td><label><a href="../monthlyreport/view_progress_history_staff.php?pid=<?=$proposalId;?>&tid=<?=$thesisId?>&id=<?=$id?>&pdid=<?=$pdid?>&mn=<?=$studentMatrixNo?>"><?=$referenceNo?></a></label></td>
