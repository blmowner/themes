...
// Program Name: review_progress_detail_faculty.php
//
// Created by: Zuraimi
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table border="0">
			...
			<br/>
			<fieldset>
			<legend><strong>Supervisor(s)</strong></legend>
			...
			<table>
				<tr>
					<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../monthlyreport/view_progress_faculty.php';" /></td>
				</tr>
			</table>	
			</br>
			<?
			...
			<table>
				...
				<tr>
					<td></br><strong>Please attach additional file if necessary:</strong></td>
				</tr>
				<tr>
				<?php
					$sqlUpload="SELECT * FROM file_upload_progress 
