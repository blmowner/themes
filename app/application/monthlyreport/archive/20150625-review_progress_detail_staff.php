...
// Program Name: review_progress_detail_staff.php
//
// Created by: Zuraimi
...
if(isset($_POST['btnSave']) && ($_POST['btnSave'] <> ""))
{
	...
	if ($progressStatus=="INP" || $progressStatus=="SV1")  {//INP, SAV1

		$sql8 = "UPDATE pg_progress_detail
				SET issues = '$studentIssues', advice = '$advice', status = 'SV1', modify_by = '$user_id', modify_date = '$curdatetime'
...
DATE_FORMAT(b.responded_date, '%d-%b-%Y %h:%i %p') as responded_date, a.student_matrix_no, a.pg_thesis_id, a.pg_proposal_id, 
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function respConfirm () {
		...
		<table>	
			...
			<table>
				<tr>
					<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../monthlyreport/review_progress_detail_view.php?mn=<?=$studentMatrixNo?>&pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&id=<?=$id;?>';" /></td>
				</tr>
			</table>
			<br/>
			<table>
				<tr>
					<td>Review Status</td>
					<td>:</td>
					<td><strong><?=$progressDetailDesc?></strong></td>
				</tr>
				<tr>
					<td>Review Date</td>
					<td>:</td>
			...
			<table>
				<tr>
					<td><textarea name="supervisorIssues" id="supervisorIssues" class="ckeditor"><?=$supervisorIssues?></textarea></td>
					<tr>
			...
			<table>
				<tr>
					...
					<tr>
					<td><strong>Attachment file by Student:</strong></td>
				</tr>
				<tr>
				<?php
					$sqlUpload="SELECT * FROM file_upload_progress 
				...
				<?php
					...
					if ($row_cnt>0)
					{
						...
						?><br/><td>No attachment found.<br/></td><?
					}
				?>
				</tr>
			</table>
