...
// Program Name: view_progress_history_staff.php
//
// Created by: Zuraimi
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="100%" class="thetable">			
			...
			AND a.pg_employee_empid NOT IN ('$user_id')
			...
			if ($row_cnt_supervisor>0) {
				do {
					...
					<tr>
						...
						<td><a href="progress_view_report_history_staff.php?eid=<?=$employeeId?>&mn=<?=$studentMatrixNo?>&pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&pdid=<?=$progressDetailId;?>" title="Description of topic or Issues facing by Student - Read more..."><img src="../images/view.jpg" width="45" height="30" style="border:0px;" title="View feedback"></a>
								</td>	
	...
	<table>
		<tr>
			<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../monthlyreport/progress_history_staff_detail.php?mn=<?=$studentMatrixNo?>';" /></td>
		</tr>
	</table>			
	<?
