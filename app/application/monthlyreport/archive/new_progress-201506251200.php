...
if(isset($_POST['btnSave']) && ($_POST['btnSave'] <> ""))
{
	...
	$theCurrDate = $currentDate->format('M-Y');
	...
	if ($theReportDate > $currentDate) {
		$msg[] = "<div class=\"error\"><span>Your Monthly Progress Report for <strong>$expectedDate1</strong> should not be later than current month <strong>$theCurrDate</strong>.</div>";
	}
			...
			<tr>
			  ...
			  <td><select name="reportMonth">
				...
				<select name="reportYear">
					...
					<?if ($reportYear=="2014") {?><option value="2015" selected="selected">2014</option><?} else {?><option value="2015">2014</option><?}?>
