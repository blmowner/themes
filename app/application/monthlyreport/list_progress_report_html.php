	...
	<legend><strong>List of Student's Monthly Progress Report</strong></legend>
		...
		<table>
			<tr>
				...
				1. The first Monthly Progress Report for this student should be <strong><?=$expectedReport?></strong>  after the earliest Supervisor's acceptance date <strong><?=$confirmAcceptanceDate?></strong> which is <strong><?=$firstMonthlyReport?></strong>.<br/>
				2. <span style="color:#FF0000">*</span> - Indicate current month.<br/>
				3. Press Ctl-P to have printing dialog box.</td>
			</tr>
		</table>		
		<?
				...
				if ($row_cnt_supervisor>0) {
					...
					do {
						...
						<tr>
							...
							<td align="left"><label><?=$departmentIdArray[$j];?></label></td>
