...
// Program Name: list_progress_report_view.php
//
// Created by: Zuraimi
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<legend><strong>List of Student's Monthly Progress Report</strong></legend>
			...
			?>
				<tr class="<?=$color?>">
					...
					if (($reportMonthReverse[$expectedMonth1] == $currMonth) && ($j==$currYear)){	?>
						<td><label><?=$my_date?> <span style="color:#FF0000">*</span></label></td>
					<?}
					else {
						?>
						<td><label><?=$my_date?></label></td>
						<?
					}?>
		...
		<table>
			<tr>		
				<td><input type="button" name="btnBack" value="Back" onclick="javascript:document.location.href='list_progress_report.php';" /></td>		
			</tr>
		</table>
		<h3><strong>Partner(s)</strong></h3>
			<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="79%" class="thetable">			
				<tr>
					...
					<th width="15%" align="left">Acceptance Date</th>
				</tr>
				 <?php				
