...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" name="form1" method="post" enctype="multipart/form-data">
			<fieldset>
				<legend><strong>List of Progress Report History </strong></legend>
				<table>
					<tr>
				...
				<?  
					...
					<tr>
						...
						<th width="45%"><strong>Thesis / Project Title</strong></th>
						<th width="10%"><strong>Reference No.</strong></th>						
						<th width="10%"><strong>Student Status</strong></th>	
						<th width="10%"><strong>Supervisor Status</strong></th>	
					...
					?>
						<tr class="<?=$color?>">
							...
							<td><label><a href="../monthlyreport/progress_history_outline_staff.php?pid=<?=$proposalId[$i];?>&mn=<?=$studentMatrixNo?>&ref=<?=$referenceNo[$i]?>"><?=$thesisId[$i]?></a></label></td>
							<td><label><?=$thesisTitleCut[$i]?></label><?=$more[$i]?></td>
							<td><label><a href="../monthlyreport/view_progress_history_staff.php?pid=<?=$proposalId[$i];?>&tid=<?=$thesisId[$i]?>&id=<?=$id[$i]?>&pdid=<?=$pdid[$i]?>&mn=<?=$studentMatrixNo?>&ref=<?=$referenceNo[$i]?>"><?=$referenceNo[$i]?></a></label></td>
					...
					?>					
					  ...
					  <table>
						<tr>
							<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../monthlyreport/progress_history_staff.php';" /></td>
						</tr>
					</table>
					<?
