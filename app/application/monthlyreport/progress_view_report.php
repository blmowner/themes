	...
	function respConfirm () {
		...
		<table>			
				...
				$varRecCount=0;	
					...
					<table>
						<tr>
							<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../monthlyreport/view_progress.php?mn=<?=$studentMatrixNo?>&pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&ref=<?=$referenceNo;?>';" /></td>
						</tr>
					</table>
					<fieldset>
					...
					<table>
						...
						?>
							...
							<?
								$sql_discussion = " SELECT a.discussed_status
					...
					<table>
						<tr>
							...
							?>
							<br/></br><strong>Attachment by Student:</strong></br>
