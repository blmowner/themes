	...
	<br/>
		...
		<table>			
				...
				$varRecCount=0;	
					...
					<table>
						<tr>
							<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../monthlyreport/view_progress_history.php?pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&pdid=<?=$progressDetailId;?>';" /></td>
						</tr>
					</table>
					<fieldset>
					...
					<table>
						<tr>
							<td><?=$advice?></td>
						<tr>
							<td></br><strong>Attachment by Supervisor:</strong></br></td>
						</td>
						<tr>
							<td>			
							<?php
						...
						<tr>
							<td></br><strong>Attachment by Student:</strong></br></td>
						</tr>
						<tr>
							<td>						
							<?php
