...
// Program Name: progress_view_report_staff.php
//
// Created by: Zuraimi
	...
	function respConfirm () {
		...
		<table>			
				...
				$varRecCount=0;	
					...
					<table>
						<tr>
							<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../monthlyreport/view_progress_staff.php?pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&id=<?=$progressId;?>&mn=<?=$studentMatrixNo;?>&ref=<?=$referenceNo;?>&theRef=<?=$theReferenceNo;?>&pdid=<?=$progressDetailId?>';" /></td>
						</tr>
					</table>
