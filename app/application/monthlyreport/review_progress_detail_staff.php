...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function respConfirm () {
		...
		<table>	
			...
			<table>
				<tr>
					<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../monthlyreport/review_progress_detail_view.php?mn=<?=$studentMatrixNo?>&pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&id=<?=$id;?>&ref=<?=$referenceNo;?>';" /></td>
				</tr>
			</table>
			<br/>
			<fieldset>
			...
			<table>
              ...
              <tr>
                ...
                <?
						...
						{ 
							?>
                    <a href="progress_download.php?fc=<?=$row["fu_cd"];?>&al=S&at=I" title="File Description: <?=$row["fu_document_filedesc"];?>">Attachment
                      <?=$attachmentNo2++;?>
