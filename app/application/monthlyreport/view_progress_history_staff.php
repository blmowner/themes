			...
			if ($row_cnt_supervisor>0) {
				do {
					...
					<tr>
						...
						<td align="center"><input type="button" name="btnBack" value="View" onClick="javascript:document.location.href='progress_view_report_history_staff.php?eid=<?=$employeeId?>&mn=<?=$studentMatrixNo?>&pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&id=<?=$progressId;?>&ref=<?=$referenceNo;?>';" /></td>	
