...
<?
	...
	a.abstract, a.publisher_id, a.website, a.country_id, a.keyword,a.publication_uploader,
...
$(document).ready(function(){
	...
	<table width="657" class="idd">
		<tr>
			<td width="132" height="32" style=""><b></b>Publication date</td>
		...
		<tr>
			<td width="84" style="background-color: rgba(105, 162, 255, 0.7);"> <b></b>ISSN </td>
			<td width="106" style="background-color: rgba(0, 0, 0, 0.1) "><?=$issn_no?></td>		
			<td width="89" style="background-color: rgba(105, 162, 255, 0.7);"> <b></b>Volume </td>
			<td width="101" style="background-color: rgba(0, 0, 0, 0.1) "><?=romanNumerals($volumeDesc)?></td>
			<td style="background-color: rgba(105, 162, 255, 0.7);"><b></b>Issue</td>
			<td width="117" style="background-color: rgba(0, 0, 0, 0.1)"><?=$issue?></td><!--rgba(0, 0, 0, 0.1);-->
		
		</tr>
		<tr>
			<td style="background-color: rgba(105, 162, 255, 0.7);"><b></b>Title </td>
		...
		<?
			...
			<td style="background-color: rgba(105, 162, 255, 0.7);"><b></b>Publisher</td>
			<td colspan="5" style="background-color: rgba(0, 0, 0, 0.1); "><?=$publisherNameDetail?></td>
		</tr>
		<tr>
			<td style="background-color: rgba(105, 162, 255, 0.7);"><b></b>Author</td>
			<td colspan="5" style="background-color: rgba(0, 0, 0, 0.1); "><?=$authorName?>
			<input type = "hidden" name = "authorID" id = "authorID" value= "<?=$authorId?>"/>
			</td>
		</tr>
		<tr>
			<td style="background-color: rgba(105, 162, 255, 0.7);"><b></b>Type of Publication</td>
			<td colspan="5" style="background-color: rgba(0, 0, 0, 0.1); ">
			<?=$typePubDesc?></td>			
		</tr>
		<td style="background-color: rgba(105, 162, 255, 0.7);"><b></b>Website</td>
			<td colspan="5" style="background-color: rgba(0, 0, 0, 0.1); "><?=$website?></td>
		
		<tr>
		<td style="background-color: rgba(105, 162, 255, 0.7);"><b></b>Country</td>
		...
		WHERE publication_id = '$pid' 
		AND upload_by = '$publication_uploader'";			
		...
		<tr>
			<td style="background-color: rgba(105, 162, 255, 0.7);"><b></b>Attachment</td>
			<td colspan="5" style="background-color: rgba(0, 0, 0, 0.1); ">
			<? for ($i=0; $i<$inc; $i++)
			{?>
		...
		<tr>
			<td style="background-color: rgba(105, 162, 255, 0.7);"><b></b><b></b>Keyword</td>
			<td style="background-color: rgba(0, 0, 0, 0.1); " colspan="5"><?=$keyword?></td>
		</tr>
		<tr>
			<td style="background-color: rgba(105, 162, 255, 0.7);"><b></b>Abstract</td>
			<td colspan="5" style="background-color: rgba(0, 0, 0, 0.1); "><?=$abstract?></td>
		</tr>
	</table>
	<table>
		<tr>
		<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../publication/list_of_publication_admin.php';" /></td>
		</tr>
	</table>
	</fieldset>
    </form>
