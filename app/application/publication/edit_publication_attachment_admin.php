...
?>
  ...
  <form id="form1" name="form1" method="post" enctype="multipart/form-data" onsubmit="return saveRec();">
	 ...
	 <fieldset>
		...
		<table>
			<tr>
				<td><input type="submit" name="submit" value="Add Attachment" onclick="javascript:open_win('edit_public_upload_admin.php?pid=<?=$pid;?>&al=S',480,280,0,0,0,1,0,1,1,0,5,'winupload'); "/></td>
			</tr>
		</table>
		<table>
		<tr>							
				...
				if ($row_cnt > 0) {	
					...
					{ 
						...
						?><tr>
								...
								<td><a href="../thesis/download.php?fc=<?=$row["fu_cd"];?>&amp;al=S" target="_blank" onMouseOver="toolTip('<?=$row["fu_document_filename"];?>', 300)" onMouseOut="toolTip()" align="center">
	...
	<table>
		<tr>
			<td><input type="button" name="btnBack" value="Back" onclick="javascript:document.location.href='../publication/edit_publication_admin.php?id=<?=$pid;?>';" /></td>		
