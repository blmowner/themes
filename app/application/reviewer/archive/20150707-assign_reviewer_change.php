			...
			<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="100%" class="thetable">
				...
				do {						
					...
					?>	
						...
						<td><input type="text" name="respondedByDate[]" size="15" id="respondedByDate<?=$no1;?>" value="<?=$respondedByDate;?>"/>
		...
		<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="100%" class="thetable">
			...
			if (($row_cnt_rv>0) && ($row_cnt_rv!=mysql_num_rows($result_sql10))) {
				...
				<tr>
					...
					<td><input type="text" name="myRespondedByDate[]" size="15" id="respondedByDate1<?=$no;?>" value="<?php echo $respondedByDate1;?>"/><?php /*?><label name="myRespondedByDate[]" size="15" id="respondedByDate" ><?=$respondedbyDate;?></label><?php */?></td>
