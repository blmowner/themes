...
if(isset($_POST['btnAssign']) && !empty($_POST['btnAssign']) )
{
	...
	//if ($arrLenghth>0){
		...
		{			
			...
			STR_TO_DATE('$myRespondedByDate[$val]','%d-%b-%Y'),'RV', 'A', '$userid', '$curdatetime', '$userid', '$curdatetime') ";
	...
	<form id="form1" name="form1" method="post" enctype="multipart/form-data">		
		...
		<br/>
			<table border="1" style="border-collapse:collapse;" cellpadding="4" cellspacing="3">
				...
				<tr>
					...
					<td><input type="text" name="respondedByDate[]" size="15" id="respondedByDate" value="<?=$respondedByDate;?>"/>
			...
			<table>
				<tr>
					<td>No reviewer has been assigned to review and provide feedback for this student.</td>
				</tr>
			</table>
			</fieldset>
			<?
		...
		<table border="1" style="border-collapse:collapse;" cellpadding="4" cellspacing="3">
			<tr>
				...
				<td><strong>Reply Date<br/></strong> within <?=$parameterValue?> day(s)</td>	
			</tr>    
			<?
			...
			<tr>
				...
				<td><label name="myRespondedByDate[]" size="15" id="respondedByDate1" ><?=$respondedbyDate1;?></label></td>
				<?$myRespondedByDate[$no]=$respondedbyDate1;	?>
