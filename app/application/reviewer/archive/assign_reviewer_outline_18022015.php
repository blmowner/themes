...
foreach($_REQUEST as $key => $value)
{
	if($key!="page")
		...
		a.faculty_remarks_by, d3.name as faculty_by_name, d4.name as assigned_name, DATE_FORMAT(a.faculty_remarks_date,'%d-%b-%Y') AS faculty_remarks_date,
		DATE_FORMAT(f.assigned_date,'%d-%b-%Y') as assigned_date, f.assigned_remarks,
		f.assigned_by,
		...
		LEFT JOIN new_employee d3 ON (d3.empid = a.faculty_remarks_by) 		
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>  
		...
		$facultyByName=$db->f('faculty_by_name');
		...
		<br/>
		<fieldset>
		<legend><strong>Remarks by Faculty for this proposal</strong></legend>		
			<table>
				<tr>
					<td>By</td>
					<td>:</td>
					<td><label name="facultyByName" size="50" id="facultyByName" ></label><?=$facultyByName;?></td>					
				</tr>
				<tr>
					<td>Date</td>
					<td>:</td>
					<td><label name="facultyRemarksDate" size="15" id="facultyRemarksDate" ></label><?=$facultyRemarksDate;?></td>					
				</tr>
				<tr>
					<td>Remarks</td>
					<td>:</td>
