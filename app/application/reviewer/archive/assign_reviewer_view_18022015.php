...
$sql6 = "SELECT a.id, a.pg_employee_empid, d.id AS dept_id, d.description AS department, b.name, 
		a.ref_supervisor_type_id, e.description AS stype, b.email, a.acceptance_status, f.description as  acceptance_desc,
	...
	<fieldset>
		...
		<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="100%">
			...
			<tr>
				...
				<td>
			    <label  name="emailId[]" id="emailId" size="20" ></label><?=$emailId?></td>
				<?$emailId[$no1]=$emailId;?>
		...
		<table>
			<tr>
				<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../reviewer/assign_reviewer';" /></td>				
			</tr>
		</table>
		<br/>
