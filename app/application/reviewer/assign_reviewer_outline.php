		...
		<fieldset>
				...
				<fieldset>
					...
					<table width="558">				
						...
						<?
						$sql1="SELECT name AS endorsed_name
							FROM new_employee
		...
		<legend><strong>Remarks by Faculty for this proposal</strong></legend>		
			<table>
				<tr>
					...
					<td>:</td>
					<?
						$sql1="SELECT name AS faculty_remarks_name
							FROM new_employee
							WHERE empid = '$faculty_remarks_by'";
							
							$dbc->query($sql1);
							$row_personal=$dbc->fetchArray();
							$facultyByName=$row_personal['faculty_remarks_name'];
					?>
