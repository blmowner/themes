...
if(isset($_POST['btnAssign']) && !empty($_POST['btnAssign']) )
{
	...
	if (sizeof($_POST['reviewerBox'])>0) {
		...
		$msg[] = "<div class=\"success\"><span>The selected Reviewer has been added into the list successfully.</span></div>";
	}
	else {
		$msg[] = "<div class=\"error\"><span>Please select the Reviewer from the list before click ASSIGN button.</span></div>";
	}
	...
	<form id="form1" name="form1" method="post" enctype="multipart/form-data">
			...
			<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="100%" class="thetable">
				...
				<tr>
					...
					<input type = "hidden" name="empId1[]" id="empId1" value="<?=$employeeId1?>"  /><br/>(<?=$employeeId1;?>)</br>
					<br/>
					<?
					if($emailStatus == 'Y')
					{		
					...
					?>
					<td><label name="myEmail1[]" id="email1" size="20" ></label><?=$email1?></td>
					<?$myEmail1[$no1]=$email1;?>
		...
		<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="100%" class="thetable">
			...
			<tr>
			  ...
			  <input type="hidden" name="empName[]" id = "empName" value="<?=$employeeNameArray[$no]?>" />
				...
				<td><label name="myEmployeeName[]" size="50" id="employeeName" ></label><?=$employeeNameArray[$no];?><br /><?
