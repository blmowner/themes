...
///////////////////////////////////////////////////////////////
		...
		$sql = "select DATE_FORMAT(f.assigned_date,'%d-%b-%Y') AS assigned_date, f.assigned_remarks, f.assigned_by
		FROM pg_proposal a 
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table>
		<tr>
			...
			<td><input type="button" name="btnBack" value="Back" onclick="javascript:document.location.href='../reviewer/edit_reviewer.php?&mn=<?=$matrixNo?>&tid=<?=$thesisId?>';" /></td>			
		</tr>	
	</table>
	<br/>
	  </form>
