...
$sql1 = "SELECT a.thesis_title, b.description as thesis_type_desc, a.introduction, a.objective, a.description, 
		a.endorsed_by, DATE_FORMAT(a.endorsed_date,'%d-%b-%Y') AS theEndorsedDate, a.endorsed_remarks, a.status,
			...
			<fieldset>
				...
				<legend><strong>Discussion Details</strong></legend>						
					<table width="100%" border="1" cellpadding="3" cellspacing="1" style="border-collapse:collapse;" class="thetable">
						<tr>						
							<th width="51"><strong>No</strong></th>	
							<th width="189"><strong>Lecturer Name</strong></th>	
							<th width="186"><strong>External Lecturer</strong></th>
							<th width="163"><strong>Meeting Mode</strong></th>
							<th width="193"><strong>Meeting Date</strong></th>
							<th width="164"><strong>Meeting Time</strong></th>
							<th width="286"><strong>Remark</strong></th>							
						</tr>
						<?
