...
if(isset($_POST['btnUpdate']) && ($_POST['btnUpdate'] <> "")) {
	$senateRemark = $_POST['senateRemark'];
	$curdatetime = date("Y-m-d H:i:s");	
	
	if ($_POST['senateRemark'] == "") $msg[] = "<div class=\"error\"><span>Update cannot be done. Please provide your remark.</span></div>";
	
	if(empty($msg))  
	{
		$sql2 = "UPDATE pg_senate
		SET remarks = '$senateRemark', modify_by = '$user_id', modify_date = '$curdatetime'
		WHERE id = '$senateId'";
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<input type="hidden" name = "supervisorEmpId" id = "supervisorEmpId" value="<?=$supervisorEmpId?>" />
		...
		?>		
		<h3><legend><strong>Thesis Progress Flow</strong></h3>
	...
	<table>
		<tr>
			<td>
				<label><strong>Senate Remark</strong></label>
			</td>
		</tr>
		<tr>
			<td><textarea name="senateRemark" id="senateRemark" class="ckeditor"><?=$_POST['senateRemark']?></textarea></td>
		</tr>
	</table>
	<table>
		<tr>
