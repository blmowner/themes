...
<body>
  ...
  <table width="501" border="0">
    <tr>
      <td width="153">Name of Parents/Guardian or Next of Kin</td>
  ...
  <p>&nbsp;</p>
  <p>
    <h><strong>In case of Emergency </strong></h>
   </p>
  <table width="501" border="0">
    <tr>
      <td width="153">Name of Contact Person</td>
      <td width="300"><input type="text" name="studentName" size="50" id="studentName" /></td>
    </tr>
    <tr>
      <td>Contact Number</td>
      <td><input type="text" name="studentName2" size="50" id="studentName2" /></td>
    </tr>
    <tr>
      <td>Relationship</td>
      <td><input type="text" name="studentName3" size="50" id="studentName3" /></td>
    </tr>
</table>
  </form>
</body>
