		...
		<div id="tabs-1">
			<fieldset style="width:900px">
			  ...
			  <table border="0" width="100%">
				...
				<td width="20%" rowspan="20" align="center">&nbsp;<img src="http://klas2.msu.edu.my/admin/student_profile/image.php?id=<?=$user_id?>" width="100" height="130" /><br> <?php /*?><input type="button" value="Upload Picture" id="submitpic" name="submitpic" alt="Recommended size:(126x170)" 
						onclick="javascript:open_win('image_insert.php?pid=<?=$user_id?>',480,280,0,0,0,1,0,1,1,0,5,'winupload'); " /><?php */?>	</td>
				</tr>
