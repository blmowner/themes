...
rps6.description AS senate_desc, DATE_FORMAT(ppa.endorsed_date,'%d-%b-%Y %h:%i%p') AS endorsed_date
FROM pg_thesis pt
...
$evaluation_desc = $dbg->f('final_result_desc');
$evaluation_date = $dbg->f('final_result_date');
		...
		<div id="tabs-1">
			<fieldset style="width:900px">
			  ...
			  <table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="100%" class="thetable">		  
				...
				<tr>
				  <th align="left"><label>Intake</label></th>
				  <td><label><?=$intake_no?></label></td>
				
				  <th align="left">Thesis /Project ID</th>
				  <td ><label><?=$thesis_id?></label></td>
				  <th align="left">Student Status </th>
				  <td ><label><?=$student_status?></label></td>
				</tr>
				<tr>
				  <th align="left"><label>Email ID</label></th>
				  <td><label><?=$email?></label></td>
				  
				  <th align="left"><label>Skype ID</label></th>
				  <td colspan="3"><label><?=$skype_id?></label></td>
				</tr>
				<tr>
			...
			<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="80%" class="thetable">	
				...
				<tr>
					...
					<td width="15%"><label name="evaluation_desc" size="10" id="evaluation_desc" value="<?=$evaluation_desc?>"></label><?=$evaluation_desc?></td>
					<td width="15%"><label name="evaluation_date" size="10" id="evaluation_date" value="<?=$evaluation_date?>"></label><?=$evaluation_date?></td>
				</tr>
				<tr>
					<td width="5%" align="center">5.</td>
					<td width="20%">Senate Endorsement </td>
					<td width="15%"><label name="final_desc" size="10" id="final_desc" value="<?=$final_desc?>"></label><?=$final_desc?></td>
					<td width="15%"><label name="final_date" size="10" id="final_date" value="<?=$final_date?>"></label><?=$final_date?></td>
				</tr>
