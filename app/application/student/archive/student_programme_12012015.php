		...
		<div id="tabs-1">
			<fieldset>
			  ...
			  <table border="0" width="100%">
				...
				<td width="25%" rowspan="20" align="center">&nbsp;<img src="image.php?userId=<?=$user_id?>" width="100" height="130" /><br> <input type="button" value="Upload Picture" id="submitpic" name="submitpic" alt="Recommended size:(126x170)" 
				...
				<tr>
				  <td>Programme</td>
				  <td colspan="3"><input type="text" name="program_code" size="15" id="program_code" value="<?=$program_code?>" disabled="disabled"/><input type="text" name="program_e" size="30" id="program_e" value="<?=$program_e?>" disabled="disabled"/></td>
				</tr>
				<tr>
				  <td>Intake</td>
			...
			<table border="0">
				...
				<tr>
				  ...
				  <td ><input type="text" name="thesisProposal" size="10" id="thesisProposal" value="<?=$proposal_desc?>" disabled="disabled"/></td
				></tr>
				<tr>
				  <td>2. </td>
				  <td>Proposal Defense </td>
				  <td><input type="text" name="proposalDefense" size="10" id="proposalDefense" value="<?=$defense_desc?>" disabled="disabled"/></td>
			
				</tr>
				<tr>
				  <td>3. </td>
				  <td>Work Completion </td>
				  <td><input type="text" name="programme" size="10" id="programme" value="<?=$work_desc?>" disabled="disabled"/></td>
			
				</tr>
				<tr>
				  <td>4. </td>
				  <td>Thesis Evaluation/VIVA </td>
				  <td><input type="text" name="intake" size="10" id="intake" value="<?=$evaluation_desc?>" disabled="disabled"/></td>
			
				</tr>
				<tr>
				  <td>5. </td>
				  <td>Final Submission </td>
				  <td><input type="text" name="thesisTitle" size="10" id="thesisTitle" value="<?=$final_desc?>" disabled="disabled"/></td>
			
				</tr>
				<tr>
				  <td>6. </td>
				  <td>Senate Endorsement </td>
				  <td><input type="text" name="thesisTitle2" size="10" id="thesisTitle2" value="<?=$senate_desc?>" disabled="disabled"/></td>
		...
		if ($row_cnt>0) {
			...
			?><table>
					<tr><td>Note: No Supervisor/Co-Supervisor has been assigned.<br/>
							...
							3. If already assigned, it could be the Supervisor/Co-Supervisor pending to accept<br/></td></tr>
