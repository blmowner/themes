...
if(isset($_POST['btnSave']) && ($_POST['btnSave'] <> ""))
{
	...
	$sqlUpdStud="INSERT INTO pg_student (matrix_no,skype_id,supervisor_status) 
				VALUES('$user_id','$skype_id','')";
...
$sql_personal="SELECT s.student_status,s.matrix_no,s.name,s.ic_passport,s.address_aa,s.address_ab,s.city_a,s.state_a,s.postcode_a,s.country_a,s.handphone,s.house,s.office,s.email,
					...
					po.code,po.program_e,sp.program_code,pgs.skype_id,pa.id,pt.id AS thesis_id
				FROM student s
				...
				LEFT JOIN pg_student pgs ON (pgs.matrix_no=pt.student_matrix_no) 
		...
		<div id="tabs-1">
			<fieldset>
			  ...
			  <table border="0" width="100%">
				...
				<td width="25%" rowspan="20" align="center">&nbsp;<img src="http://klas2.msu.edu.my/admin/student_profile/image.php?id=<?=$user_id?>" width="122" height="147" ><br>	</td>
				</tr>
				...
				<tr>
				  ...
				  <? } else { ?>
				  <td width="39%"><input type="text" name="skype_id" size="30" id="skype_id" value="<?=$skype_id?>" disabled="disabled"/></td>
				  <? } ?>
				</tr>
			</table>
		...
		<div id="tabs-2">
			...
			<table border="1" cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#cccccc" bordercolordark="#eeeeee">
				<tr>
				 ...
				 <?php				
        $sql="SELECT * FROM pg_supervisor WHERE id='$thesis_id' ORDER BY type  ";					
