...
echo $sql_personal="SELECT s.student_status,s.matrix_no,s.name,s.ic_passport,s.address_aa,s.address_ab,s.city_a,s.state_a,s.postcode_a,s.country_a,s.handphone, 
		...
		<div id="tabs-1">
			<fieldset style="width:900px">
			  ...
			  <table border="0" width="100%">
				...
				<td width="20%" rowspan="20" align="center">&nbsp;<img src="http://klas2.msu.edu.my/admin/student_profile/image.php?id=<?=$user_id?>" width="100" height="130" /><br> <input type="button" value="Upload Picture" id="submitpic" name="submitpic" alt="Recommended size:(126x170)" 
