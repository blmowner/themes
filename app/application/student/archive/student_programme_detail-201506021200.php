...
pa.verified_date, pa.status,pa.thesis_title,pa.id,pt.id AS thesis_id, 
...
?>
  ...
  <input type="hidden" name="matrix_no" id="matrix_no" value="<?php echo $matrix_no; ?>">
 	...
 	<div id="tab1" style="width:950px">
				...
				<?
				  ...
				  ?>
					<tr>
						...
						<td width="80%"><?=$dbstux->f("name")?></td>
					</tr>
					<tr> 
						<td width="15%">Matric No</td>
						 <td width="3%" align="center">:</td>
						<td width="80%"><?=$dbstux->f("matrix_no")?></td>
					</tr>					
					<tr>
					  <td width="15%">Cohort</td>
					  <td width="3%" align="center">:</td>
					  <td width="80%"><?=$dbstux->f("intake_no")?></td>
					</tr>
					<?
		...
		<div id="tabs-4">			
				<iframe id="iframeAma" src="../thesis/proposal_history_staff_detail.php?matrix_no=<?=$matrix_no;?>&search=<?=$search?>" frameborder="0" style="height:500px;width:100%"></iframe>
				<?php //include("../thesis/proposal_history_staff_detail.php"); ?>
		</div>
	</div>
	<table>
			<tr>
				<td><input type="button" name="btnBack" value="Back to Student List" onclick="javascript:document.location.href='student_programme_staff.php?act=<?=$act?>&search=<?=$search?>';" /></td>		
			</tr>
	</table>
 </form>
</body>
