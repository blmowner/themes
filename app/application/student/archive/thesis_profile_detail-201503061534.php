...
s.house,s.office,s.email,s.address_bb,s.address_ba,s.city_b,s.state_b,s.postcode_b,s.country_b,s.xgender,sp.intake_no,po.code,po.program_e,sp.program_code,s.skype_id
FROM student s
...
$dbc->query($sql_personal);
$row_personal = $dbc->fetchArray(); //echo $sql_personal;
...
?>
  ...
  <input type="hidden" name="matrix_no" id="matrix_no" value="<?php echo $matrix_no; ?>">
		...
		<div id="tabs-1">
			<fieldset style="width:900px">
			  ...
			  <table border="0" width="100%">
				...
				<td width="20%" rowspan="20" align="center">&nbsp;<img src="http://klas2.msu.edu.my/admin/student_profile/image.php?id=<?=$matrix_no?>" width="100" height="130" /><br> <?php /*?><input type="button" value="Upload Picture" id="submitpic" name="submitpic" alt="Recommended size:(126x170)" 
						onclick="javascript:open_win('image_insert.php?pid=<?=$matrix_no?>',480,280,0,0,0,1,0,1,1,0,5,'winupload'); " /><?php */?>	</td>
				</tr>
			...
			/*$sql="SELECT  a.pg_employee_empid, b.name, c.id, c.description,b.mobile, b.email, b.skype_id, 
				...
				while($row = mysql_fetch_array($result)) 
					...
					{ 	
						...
						$result1 = $dbc->query($sqlSupervisor);
						$row_supervise=$dbc->fetchArray();
	...
	<table>
			<tr>
				<td><input type="button" name="btnBack" value="Back" onclick="javascript:document.location.href='../student/thesis_profile.php';" /></td>		
			</tr>
	</table>
 </form>
</body>
