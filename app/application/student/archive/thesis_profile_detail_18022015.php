...
s.house,s.office,s.email,s.address_bb,s.address_ba,s.city_b,s.state_b,s.postcode_b,s.country_b,s.xgender,sp.intake_no,pa.verified_by,pa.verified_date,
...
?>
  ...
  <input type="hidden" name="matrix_no" id="matrix_no" value="<?php echo $matrix_no; ?>">
	...
	<table>
			<tr>
				<td><input type="button" name="btnBack" value="Back" onclick="javascript:document.location.href='thesis_profile_detail.php';" /></td>		
			</tr>
	</table>
 </form>
</body>
