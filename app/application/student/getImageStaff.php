...
include("../../../lib/common.php");
	...
	$sql = "SELECT SUBSTRING(app_date,1,4) AS year FROM new_employee 
			WHERE empid = '".$staff_id."'
			AND xemployee_status = 'AC'";
	
	if (substr($staff_id,0,3) != 'S07') 
	{ 
		$dbstupic=$dbc; 
	} 
	else 
	...
	$year = $dbstupic->f("year");
	
	////retrieve image from other database
	$sql1 = "SELECT mime_type,pic_contents FROM new_employee_pic_".$year." WHERE empid = '$staff_id'";
