...
?>
  ...
  <input type="hidden" name="matrix_no" id="matrix_no" value="<?php echo $matrix_no; ?>">
	...
	<table>
			<tr>
				<td><input type="button" name="btnBack" value="Back to Student List" onclick="javascript:document.location.href='student_programme_faculty.php?act=<?=$act?>&search=<?=$search?>';" /></td>		
			</tr>
	</table>
 </form>
</body>
