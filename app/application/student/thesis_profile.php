				...
				<tr>
					...
					<td width="80%" class="tbmain">
					  <input name="search" value="<?=$search?>" size="50"></input>
				  	  <input type="submit" name="find" value="Search" onClick="return check(document.f1)"><span style="color:#FF0000"></input></td>
				</tr>
			</table>
			<table>
				<tr>
					<td><span style="color:#FF0000">Note:</span> If no entry is provided, it will search all postgraduate student.</td>
				</tr>
			</table>
			<br />
			<table>
					...
					$matrix_no=array();					
						...
						for ($i=0; $i<$inc; $i++) 
						{
							...
							<tr>
								...
								<td align="center"><input type="button" value="View" onClick="javascript:document.location.href='thesis_profile_detail.php?matrix_no=<?=$matrix_no[$i]?>&search=<?=$search?>&act=search';" name="B3"></td>
							</tr>
							<?
							}
					}
