...
WHERE a.student_matrix_no = '$matrix_no'
...
WHERE a.status = 'A'
AND a.student_matrix_no = '$matrix_no'
AND a.pg_thesis_id = '$thesis_id'
AND a.pg_proposal_id = '$proposal_id'
...
?>
  ...
  <input type="hidden" name="matrix_no" id="matrix_no" value="<?php echo $matrix_no; ?>">
			...
			<fieldset style="width:900px">
			  ...
			  <table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="100%" class="thetable">		  
			  	<tr>
					...
					<td colspan="7" ><label><?=$matrix_no?></label></td>	
					<td rowspan="6" align="center"> <img src="getImage.php?userId=<?=$matrix_no?>" width="100" height="130" /><br> <?php?></td>						
				</tr>
	...
	<table>
			<tr>
				<td><input type="button" name="btnBack" value="Back to Student List" onclick="javascript:document.location.href='../student/thesis_profile_staff.php?act=<?=$act?>&search=<?=$search?>';" /></td>		
			</tr>
	</table>
 </form>
</body>
