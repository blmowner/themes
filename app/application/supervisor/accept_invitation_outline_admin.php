...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
				...
				<legend><strong>Discussion Details</strong></legend>						
					<table width="904">
						<tr>						
							...
							<td width="141"><strong>Lecturer Name</strong></td>	
							<th width="170" class="thetable"><strong>Meeting Mode</strong></th>
							<td width="129"><strong>Meeting Date</strong></td>
							<td width="123"><strong>Meeting Time</strong></td>
							<td width="275"><strong>Remark</strong></td>							
						</tr>
						<?
						$no=1;
						do
						...
						<tr>		
							...
							<td class="thetable"><label name="meetingmode" size="25" id="meetingmode" >
                              <?=$meeting_mode?>
                            </label></td>
		...
		<table>
			<tr>		
				<td><input type="button" name="btnBack" value="Back" onclick="javascript:document.location.href='accept_invitation_admin.php';" /></td>		
			</tr>
		</table>
		</form>
	</body>
