				...
				<legend><strong>List of Thesis / Proposal</strong></legend>
					...
					<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="100%" class="thetable">
                      ...
                      <tr>
                        ...
                        <td><label name="myThesisTitle[]" cols="45" id="thesisTitle"><?=substr($thesisTitleArray[$i],0,100)?></label>
						<a href="#" name="" value="<?=$pgThesisIdArray[$i]?>" title="<?=$thesisTitleArray[$i]?>">Read more..</a></td>
