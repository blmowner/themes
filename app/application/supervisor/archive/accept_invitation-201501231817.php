...
$sql1 = "SELECT	a.id, a.assigned_by, DATE_FORMAT(a.assigned_date,'%d-%b-%Y') AS assigned_date, 
		...
		DATE_FORMAT(f.senate_mtg_date,'%d-%b-%Y') AS senate_mtg_date, a.pg_student_matrix_no, 
	...
	<body>
		<form id="form2" name="form2" method="post" enctype="multipart/form-data">
			...
			<?
				...
				<table>
					<tr>
						<td><span class="style1">Note:</span> Please enter your <strong>Remarks</strong> above if to reject the appointment as Supervisor/Co-Supervisor.</td>
					</tr>
				</table>
				<br/>
				<table>
				...
				<?
					...
					<table>
						<tr>
							<td>
								<p>Currently no invitation is available for you to respond.</p>
							</td>
						</tr>
					</table>
					<?
