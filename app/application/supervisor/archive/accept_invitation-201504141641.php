						...
						?>
							<tr>
								...
								<?if ($acceptanceStatusArray[$i]=='ACC') {
									?>Acceptance Date: <?=$acceptanceDateArray[$i];
								}
								else {
									?>Rejected Date: <?=$acceptanceDateArray[$i];
								}?>
								</br>
								<a href="accept_invitation_detail.php?sid=<?=$supervisorIdArray[$i];?>" name="acceptanceRemarks[]" value="<?=$acceptanceRemarksArray[$i]?>" title=""><br/>
							
							
								<?
								if (strlen($acceptanceRemarksArray[$i]) == 0) {?>
								
									<img src="../images/red_edit.jpg" width="20" height="19" style="border:0px;" title="Enter remarks here" >Enter Remarks</a></td>	
								<?}
								else {
								?>
									<img src="../images/edit.jpg" width="20" height="19" style="border:0px;" title="Read remarks detail" >Read Remarks</a></td>	
								<?
								}?>
