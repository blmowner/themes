	...
	while (list ($key,$val) = @each ($supervisorBox1)) 
		{
			...
			SET ref_supervisor_type_id='$myDropDownSType1[$val]', 
	...
	//if ($arrLenghth>0){
		...
		{			
			...
			$sql4="INSERT INTO pg_supervisor
				...
				VALUES ('$run_pg_supervisor_id', '$myEmployeeId[$val]', '$matrixNo', '$userid', '$curdatetime', STR_TO_DATE('$myRespondedByDate[$val]','%d-%b-%Y'),'$myDropDownSType[$val]', 'A', '$userid', '$curdatetime', '$userid', '$curdatetime') ";
		...
		if ($row_cnt>0) {?>		
			...
			<table border="1" style="border-collapse:collapse;" cellpadding="4" cellspacing="3">
				...
				<tr>
					...
					<td><label name="myEmployeeName1[]" size="50" id="employeeName1"></label><?=$employeeName1;?><br/>(<?=$employeeId1;?>)</td>
