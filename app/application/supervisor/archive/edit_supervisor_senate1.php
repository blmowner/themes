	...
	//if ($arrLenghth>0){
		...
		{			
			...
			$sql4="INSERT INTO pg_supervisor
				(id, pg_employee_empid, pg_student_matrix_no, assigned_by, assigned_date,
				respondedby_date, ref_supervisor_type_id, status, insert_by, insert_date, modify_by, modify_date)
				VALUES ('$run_pg_supervisor_id', '$myEmployeeId[$val]', '$matrixNo', '$userid', '$curdatetime' 
				,STR_TO_DATE('$myRespondedByDate[$val]','%d-%b-%Y'),'$myDropDownSType[$val]', 'A', '$userid', '$curdatetime', '$userid', '$curdatetime') ";
		...
		if ($row_cnt>0) {?>		
			...
			<table border="1" style="border-collapse:collapse;" cellpadding="4" cellspacing="3">
				...
				<tr>
					...
					<td><input type="text" name="respondedByDate[]" size="15" id="respondedByDate" value="<?php echo $respondedByDate;?>"/></td>
		...
		<table border="1" style="border-collapse:collapse;" cellpadding="4" cellspacing="3">
			...
			<tr>
				...
				<?
					...
					<td><input type="text" name="myRespondedByDate[]" size="15" id="respondedByDate<?=$no;?>" value="<?php echo $respondedByDate;?>"/></td>
