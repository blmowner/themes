	...
	//echo var_dump($_POST);
		...
		{			
			...
			if ($myDropDownSType[$val]=='') $role='XS';
				...
				VALUES ('$run_pg_supervisor_id', '$myEmployeeId[$val]', '$matrixNo', '$thesisId', '$userid', '$curdatetime', STR_TO_DATE('".$_POST[$myRespondedByDate][$val]."','%d-%b-%Y'),'$role', 'A', '$userid', '$curdatetime', '$userid', '$curdatetime') ";
