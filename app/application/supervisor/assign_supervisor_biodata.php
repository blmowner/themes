		...
		<form id="form2" name="form2" method="post" enctype="multipart/form-data">
			...
			<table>
				<tr>
					...
					<td><input type="button" name="btnBack" value="Back" onclick="javascript:document.location.href='../supervisor/assign_supervisor_change.php?tid=<?=$thesisId;?>&pid=<?=$proposalId;?>&mn=<?=$matrixNo;?>&sname=<?=$studentName;?>';" /></td>
				</tr>
			</table>
			<table>	
				<tr>
