...
// Program Name: assign_supervisor_biodata.php
//
// Created by: Zuraimi
...
?>
		<form id="form2" name="form2" method="post" enctype="multipart/form-data">
			...
			<table>	
				<tr>
					<td><br/><label>Please enter brief biodata for this supervisor:-</label></td>					
				</tr>
				<tr>
			...
			<table>
				<tr>
					...
					<td><input type="button" name="btnBack" value="Back" onclick="javascript:document.location.href='../supervisor/edit_supervisor_senate.php?tid=<?=$thesisId;?>&pid=<?=$proposalId;?>&mn=<?=$matrixNo;?>&sname=<?=$studentName;?>';" /></td>
				</tr>
			</table>
