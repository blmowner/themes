...
DATE_FORMAT(a.assigned_date,'%d-%b-%Y') AS assigned_date, a.assigned_by, a.unassigned_remarks, b.email_status 
FROM pg_supervisor a
LEFT JOIN ref_supervisor_type e ON (e.id = a.ref_supervisor_type_id)
...
<?
			...
			<table>
				<tr>
					<td><td><span style="color:#FF0000">Note:</span>
					<label style="color:#010000">Auto email notification to Supervisor trigger by faculty's action is currently disabled by Admin.</label></td>
				</tr>
			</table>
			<? } ?>
