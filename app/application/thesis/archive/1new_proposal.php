...
<script>
	...
	alert( document.getElementById( 'introduction' ).value );
</script>
<?
	...
	if($_POST['jobs1_area'] == "") $msg[] = "<div class=\"error\"><span>Please select Thesis Area</span></div>";
			...
			if(empty($msg)) 
			{	
						$msg[] = "<div class=\"success\"><span>Your thesis proposal has been submitted to the Faculty for verification.</span></div>";
						$myjobs_area1 = $_POST['jobs1_area'];
						$myjobs_area2 = $_POST['jobs2_area'];
						$myjobs_area3 = $_POST['jobs3_area'];
						$myjobs_area4 = $_POST['jobs4_area'];
...
{
	saveStatus=true;
	//var introduction = CKEDITOR.instances.introduction.updateElement();
	...
	alert("objective: " + document.form1.objective.value);
	alert("description: " + document.form1.description.value);
...
$(function() 
{
  ...
  <form id="form1" name="form1" action = "new_proposal.php" method="post" enctype="multipart/form-data" > 
...
CKEDITOR.instances[introduction.introduction].updateElement(); // update textarea

</script>		</tr>
		<tr>
			<td><span style="color:#FF0000">*</span> Objective</td>
			<td><textarea name="objective" cols="30" value = ""  class="ckeditor" rows="3" ><?=$objective;?></textarea></td>
		</tr>
		<tr>
			<td><span style="color:#FF0000">*</span> Brief Description</td>
			<td><textarea name="description" cols="30" value = ""  class="ckeditor" rows="3" ><?=$description;?></textarea></td>
		</tr>
	</table>
	<table>
     <tr>
										...
										$result = $db_klas2->query($sqlMeeting); //echo $sql;
											...
											{ 
												?><tr>
													...
													<a href="../thesis/delete_meeting_detail.php?id=<?=$row["id"];?>"><img src="../images/delete_on.gif" width="20" height="19" style="border:0px;" title="Delete Meeting Information" ></a>
													</td>		
													</tr>
											<?} ?> 	
		 </table>
	   ...
	   <fieldset style="width:800px">
		 ...
		 <table>
			<tr>
				...
				<td><input type="submit" name="btnSubmit" id="btnSubmit" align="center"  value="Submit" onClick="return cubasubmit()" /></td>
