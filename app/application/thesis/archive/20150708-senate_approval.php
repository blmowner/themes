...
if(isset($_POST['btnSubmit']) && ($_POST['btnSubmit'] <> "")) 
{
	...
	if (sizeof($_POST['myApprovalBox'])>0) {
		...
		VALUES ('$proposalApprovalId', '$endorsedStatus', '$userid', STR_TO_DATE('$senateMtgDate','%d-%b-%Y'), '$endorsedRemarks', '$userid', 
		...
		while (list ($key,$val) = @each ($myApprovalBox)) {
			...
			while($db->next_record())
			{
				...
				if($verified == 'APP')
				{
					...
					/*else
					{
						echo "valid = $constvalue";
						echo "email = $emailStatus";
					}*/
			...
			if($constvalue == 'Y')
			{
				...
				{
					//echo "Email not sent Dalam for faculty";
				}
			}
			else
			{
				//echo "Email not sent Luar";
			}
/*************************************************Message Notification**************************/
			$verified = $_REQUEST['endorsedStatus'];
			if($verified == 'APP')
...
/*************************************************Message Notification End**************************/
			...
			if($constvalue == 'Y')
			{
				...
				{
					//echo "Email not sent dalam for student";	
				}
