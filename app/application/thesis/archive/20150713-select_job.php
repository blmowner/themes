...
<form id="frmPopup" action="" onsubmit="" method="post" name="frmPopup" enctype="multipart/form-data">
  <p>
	...
	?>
  <table width="80%" style="margin-top:10px; margin-left:65px;">
		<tr>
			...
			<td width="45%"><select name="job_id" id ="job_id" style="font-family:verdana; font-size: 11.0px;">
			  ...
			  <?php 
				$parent = '000';
				$sqlsearch = "SELECT JobArea,area FROM job_list_category WHERE SUBSTRING(JobArea,3,5) = '$parent' ORDER BY JobArea ASC ";
  ...
  <table cellpadding="3" cellspacing="3" width="90%" class="thetable" style="margin-top:10px; margin-left:35px;">
    <tr>
