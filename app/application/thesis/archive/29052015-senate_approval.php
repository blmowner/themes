...
function newAttachment() 
{
	...
	return false;
		...
		?>
			...
			<table>
				<tr>	
					<td><input type="button" name="btnPrintProposal" id="btnPrintProposal" value="Print Proposal List" onclick="javascript:document.location.href='pdf_senate_approval.php';"/></td>
