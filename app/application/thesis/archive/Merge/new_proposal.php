...
if(isset($_POST['btnSubmit']) && ($_POST['btnSubmit'] <> ""))
{
	...
	if(empty($msg)) 
	{
		/*$job_area1 = $_REQUEST['JobArea'];
		$job_area2 =  $_REQUEST['JobArea1'];
		$job_area3 = $_REQUEST['JobArea2'];
		$job_area4 =  $_REQUEST['JobArea3'];
		$job_area5 = $_REQUEST['JobArea4'];
		$job_area6 =  $_REQUEST['JobArea5'];

		$jobID1 =  $_REQUEST['JobAreaID'];
		$jobID2 =  $_REQUEST['JobAreaID1'];
		$jobID3 =  $_REQUEST['JobAreaID2'];
		$jobID4 =  $_REQUEST['JobAreaID3'];
		$jobID5 =  $_REQUEST['JobAreaID4'];
		$jobID6 =  $_REQUEST['JobAreaID5'];*/
