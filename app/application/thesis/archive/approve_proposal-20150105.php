			...
			<?  
				...
				?>
					<tr>
						...
						<td><input type="text" name="myStudentMatrixNo[]" size="12" id="studentMatrixNo" value="<?=$studentMatrixNo;?>" disabled="disabled"/></td>
						...
						<?}
							...
							<td><a href="../supervisor/assign_supervisor.php?pid=<?php echo $id?>&matrixNo=<? echo $studentMatrixNo?>&sname=<? echo $studentName?>" class="style1">Assign</a></td>
						<?}?>															
					</tr>
				<?
				$no=$no+1;
