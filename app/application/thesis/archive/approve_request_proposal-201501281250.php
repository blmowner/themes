	...
	<body>  
		<form id="form1" name="form1" method="post" enctype="multipart/form-data">				
				...
				<legend><strong>List of Thesis Proposal</strong></legend>
					<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="100%">
						...
						?>
							...
							<tr>
								...
								<td><a href="cancel_proposal_outline.php?thesisId=<? echo $pgThesisId;?>&proposalId=<? echo $proposalId;?>" name="myPgThesisId[]" value="<?=$pgThesisId?>" title="Outline of Proposed Case Study by the Student - Read more..."><?=$pgThesisId;?></a><br/>
					...
					<table>					
						<tr>				
							<td><input type="submit" name="btnSubmit" value="Cancel as requested" /></td>
						</tr>
					</table>							
					<?
				}
