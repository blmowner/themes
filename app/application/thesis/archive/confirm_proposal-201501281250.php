						...
						?>
							...
							<tr>
								...
								if ($supervisorStatus =='A') {?>
									<a href="../supervisor/edit_supervisor.php?pid=<?php echo $proposalId?>&tid=<? echo $pgThesisId?>&mn=<? echo $studentMatrixNo?>">Change <img src="../images/edit.jpg" width="20" height="19" style="border:0px;" title="Supervisor has been assigned" ></a><br/>
									<br/><a href="../supervisor/view_supervisor.php?sname=<?php echo $studentName?>&mn=<? echo $studentMatrixNo?>">View</a> 
								<?}
								else {?>
									<a href="../supervisor/edit_supervisor.php?pid=<?php echo $proposalId?>&tid=<? echo $pgThesisId?>&mn=<? echo $studentMatrixNo?>">Assign <img src="../images/red_edit.jpg" width="20" height="19" style="border:0px;" title="Supervisor is not assigned yet" ></a>
								<?}?>															
							</td>
					...
					<table>				 
						 <tr>
							...
							<td>				
								...
								<input type="radio" name="myVerifiedStatus" value="CAN"/>Cancel as requested
							</td>
						</tr>
					</table>
					</fieldset>
