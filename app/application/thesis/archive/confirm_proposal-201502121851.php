...
if(isset($_POST['btnSubmit']) && ($_POST['btnSubmit'] <> "")) {
	...
	if (sizeof($_POST['myApprovalBox'])>0) {
		...
		$area = "INSERT INTO pg_proposal_area
			...
			VALUES('$proposal_id','$proposal_id','$jobArea1','$jobArea2','$jobArea3','$jobArea4','$jobArea5','$jobArea6',
			'$curdatetime','$userid','$curdatetime','$userid')";
				...
				<legend><strong>List of Thesis Proposal</strong></legend>
					...
					<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="100%">
						...
						?>
							...
							<tr>
								...
								<? if ($verifiedStatus=='APP' || $verifiedStatus=='AWC' || $verifiedStatus=='REQ' || $verifiedStatus=='DIS'){
								...
								if (($tmpNewReportDate->format('d-M-Y') >= $currentDate->format('d-M-Y')) && ($verifiedStatus=='')) {
								?>
								...
								<td><a href="proposal_outline.php?thesisId=<? echo $pgThesisId;?>&proposalId=<? echo $proposalId;?>" name="myPgThesisId[]" value="<?=$pgThesisId?>" title="Outline of Proposed Case Study by the Student - Read more..."><?=$pgThesisId;?><br/>
					...
					<table>					
						<tr>				
							...
							<td><input type="submit" name="btnSubmit" value="Submit" /><span style="color:#FF0000"> Note:</span> Ensure the proposal above has been selected before click Submit.</td>
						</tr>
					</table>							
					<?
				}
