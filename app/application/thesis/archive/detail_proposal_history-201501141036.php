...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" name="form1" method="post" enctype="multipart/form-data">
			...
			<table width="410">
				<tr>
					<td width="129">Approved By</td>	
				    <td width="10">:</td>
			      <td width="255"><label><?=$approvedName?></label></td>
				</tr>
				<tr>
			...
			<table>
				<tr>
					<td><strong>Confirmation Information by Faculty </strong>
				</tr>
			</table>
			<table width="410">
			<tr>
					<td width="128">Confirmed By</td>	
			        <td width="10">:</td>
	          <td width="256"><label><?=$confirmName?></label></td>
			  </tr>
				<tr>
			...
			<table width="410">
				<tr>
					<td width="121">Introduction</td>
				    <td width="10">:</td>
			      <td width="230"><label class="ckeditor"/><?=$introduction?></label></td>		
				</tr>
				<tr>
					<td>Objective</td>			
					<td>:</td>
