...
{	
	...
	{	
		...
		$area = "INSERT INTO pg_proposal_area
			...
			VALUES('$proposal_id','$proposal_id','$jobs_area1','$jobs_area2','$jobs_area3','$jobs_area4',
	...
	else //has record
	{
		if (strcmp($verified_status,'SAV')==0)
		{
			...
			SET pg_proposal_id = '$proposal_id',job_id1_area = '$jobs_area1', job_id2_area = '$jobs_area2', job_id3_area = '$jobs_area3',
			...
			$area = "INSERT INTO pg_proposal_area
			(id,pg_proposal_id,job_id1_area,job_id2_area,job_id3_area,job_id4_area,job_id5_area,job_id6_area,insert_date,insert_by,modified_date,modified_by)
			VALUES('$new_proposal_id','$new_proposal_id','$jobs_area1','$jobs_area2','$jobs_area3','$jobs_area4',
			'$jobs_area5','$jobs_area6','$curdatetime','".$_SESSION['user_id']."','$curdatetime','".$_SESSION['user_id']."')";
			$db_klas2->query($area); //echo $area;
