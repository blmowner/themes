...
<legend><strong>Edit Application - Outline of Proposed Research/Case Study</strong></legend>	
	...
	<input type="hidden" name="discussion_status" id="discussion_status" value="Y" />
	   ...
	   ?>
		  <table>
			<tr>
				<td><input type="button" name="btnDiscussionDetail" value="Discussion Detail (<?=$row_cnt_discussion?>)" onclick="javascript:document.location.href='../thesis/edit_proposal_discussion.php?tid=<?=$thesis_id?>&pid=<?=$proposal_id?>';" /></td>
				<td><input type="button" name="btnAttachment" value="Attachment (<?=$row_cnt_attachment?>)" onclick="javascript:document.location.href='../thesis/edit_proposal_attachment.php?tid=<?=$thesis_id?>&pid=<?=$proposal_id?>';" /></td>		
			</tr>
		</table>
  </fieldset>
  <table>
