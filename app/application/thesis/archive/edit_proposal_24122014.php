...
<body>
  ...
  <tr>
    ...
    <tr>
      <td>Feedback Date</td>
      <td><input name="reportDate" type="text" id="reportDate" value="16/12/2014" size="15" disabled="disabled"/></td>
    </tr>
     ...
     <tr>
	  ...
	  <td><p>
	    <label><input type="radio" name="approvalStatus" value="Recommended for Approval" disabled="disabled"/>Approved</label>
	    <label><input name="approvalStatus" type="radio" value="request" checked="checked" disabled="disabled" />
	    Request with Changes</label>
	    <label><input type="radio" name="approvalStatus" value="request" disabled="disabled"/>Disapproved</label>		
	</td>
    </tr>
	<tr>
	<td> Remarks </td>
		<td><textarea name="objective" rows="2" cols="50" id="objective" disabled="disabled">Please do the changes as discussed today</textarea></td>
	</tr>
   <tr>
   <td></td>
   <td><input type="submit" name="attachment" value="View Attachment"/>   </td>
	...
	<tr>
      <td>Report Date </td>
      <td><input name="reportDate" type="text" id="reportDate" value="15/12/2014" size="15" disabled="disabled"/></td>
    </tr>	
	<tr>
      <td>Student Name </td>
      <td><input name="studentName" type="text" id="studentName" value="Bui Ngoc Dung" size="50" disabled="disabled"/></td>
    </tr>
    <tr>
      <td>Telephone </td>
      <td><input name="telephone" type="text" id="telephone" value="013-3921122" size="50" disabled="disabled"/></td>
    </tr>
    <tr>
      <td>Email</td>
      <td><input name="email" type="text" id="email" value="bui@hotmail.com" size="50" disabled="disabled"/></td>
    </tr>
    <tr>
      <td>Matrix Number</td>
      <td><input name="matrixNumber" type="text" id="matrixNumber" value="102014-03-0001" size="50" disabled="disabled"/></td>
    </tr>
    <tr>
      <td>Programme</td>
	...
	<tr>
      <td>Intake</td>
      <td><input name="intake" type="text" id="intake" value="May 2014" size="50" disabled="disabled"/></td>
    </tr>
	<tr>
...
<p><strong>  Outline of Proposed Research/Case Study</strong></p>
 <table >
    ...
    <tr>
      ...
      <td ><textarea name="textarea" cols="50" id="textarea">Model-Free Analysis of Single and Multiple fMRI Time Series Based on Spatial Synchronization</textarea></td>
      
    </tr>
	<tr>
	  <td>Thesis ID </td>
	  <td><input type="text" name="thesisID" size="50" id="thesisID" value="201411001"/></td>
	  </tr>
    <tr>
      <td>Propose</td>
      <td><p>
    ...
    <tr>
      <td>Introduction</td>
	  <td><textarea rows="2" cols="30" name="introduction"></textarea></td>
	  
    </tr>
    <tr>
      <td>Objective</td>
      <td><textarea rows="2" cols="30" name="objective"></textarea></td>
  ...
  <strong>Discussion Details </strong><br />
   <table>
     <tr>
      <td><p>Have you discussed about your research/case to any Lecturer of MSU?   
