...
{	
	...
	{	
		...
		$area = "INSERT INTO pg_proposal_area
			...
			VALUES('".$proposal_id."','".$proposal_id."','".$_POST['jobs1_area']."','".$_POST['jobs2_area']."','".$_POST['jobs3_area']."','".$_POST['jobs4_area']."',
			'".$_POST['jobs5_area']."','".$_POST['jobs6_area']."',now(),'".$_SESSION['user_id']."',now(),'".$_SESSION['user_id']."')";
		$db_klas2->query($area); //echo $area;
		// --- Job Area Category (FINISH) ---
		
		/*$updateArea = "UPDATE pg_proposal_area
			SET job_id1_area = '".$_POST['jobs_area']."', job_id2_area = '".$_POST['jobs2_area']."', job_id3_area = '".$_POST['jobs3_area']."',
				job_id4_area = '".$_POST['jobs4_area']."',job_id5_area = '".$_POST['jobs5_area']."',job_id6_area = '".$_POST['jobs6_area']."',
				insert_date = now(), insert_by = '".$_SESSION['user_id']."', modified_date = now(), modified_by = '".$_SESSION['user_id']."'
			WHERE id = '$proposal_id' and pg_proposal_id = '$proposal_id' ";
	...
	else //has record
	{
		if (strcmp($verified_status,'SAV')==0)
		{
			...
			$updateArea = "UPDATE pg_proposal_area
			SET job_id1_area = '$jobs1_area', job_id2_area = '$jobs2_area', job_id3_area = '$jobs3_area',
				job_id4_area = '$jobs4_area',job_id5_area = '$jobs5_area',job_id6_area = '$jobs6_area',
				insert_date = now(), insert_by = '".$_SESSION['user_id']."', modified_date = now(), modified_by = '".$_SESSION['user_id']."'
		...
		/*$area = "INSERT INTO pg_proposal_area
			(id,pg_proposal_id,job_id1_area,job_id2_area,job_id3_area,job_id4_area,job_id5_area,job_id6_area,insert_date,insert_by,modified_date,modified_by)
			VALUES('".$proposal_id."','".$proposal_id."','".$_POST['jobs_area']."','".$_POST['jobs2_area']."','".$_POST['jobs3_area']."','".$_POST['jobs4_area']."',
			'".$_POST['jobs5_area']."','".$_POST['jobs6_area']."',now(),'".$_SESSION['user_id']."',now(),'".$_SESSION['user_id']."')";
		$db_klas2->query($area); echo $area;*/
		}
			...
			if ($row_cnt>0) {							
				...
				// --- Job Area Category (START) ---
		/*$area = "INSERT INTO pg_proposal_area(id,pg_proposal_id,job_id1_area,job_id2_area,job_id3_area,job_id4_area,job_id5_area,job_id6_area,insert_date,insert_by,modified_date,modified_by)
				VALUES('".$proposal_id."','".$proposal_id."','".$_POST['jobs_area']."','".$_POST['jobs2_area']."','".$_POST['jobs3_area']."','".$_POST['jobs4_area']."','".$_POST['jobs5_area']."',
...
if(isset($_POST['btnSubmit']) && ($_POST['btnSubmit'] <> ""))
{
	...
	else 
	{
		if ($verified_status=='SAV')
		{
			...
			$updateArea = "UPDATE pg_proposal_area
			SET pg_proposal_id = '$proposal_id', job_id1_area = '$jobs1_area', job_id2_area = '$jobs2_area', job_id3_area = '$jobs3_area',
				job_id4_area = '$jobs4_area',job_id5_area = '$jobs5_area',job_id6_area = '$jobs6_area',
				insert_date = now(), insert_by = '".$_SESSION['user_id']."', modified_date = now(), modified_by = '".$_SESSION['user_id']."'
			WHERE id = '$proposal_id' ";
			$db_klas2->query($updateArea); //echo $updateArea;
		...
		$db_klas2->query($sqlsubmit2); 
			...
			$db_klas2->query($sql3);
				...
				// --- Job Area Category (START) ---
	/*$area = "INSERT INTO pg_proposal_area(id,job_id1_area,job_id2_area,job_id3_area,job_id4_area,job_id5_area,job_id6_area,insert_date,insert_by,modified_date,modified_by)
      ...
      <td><p>Have you discussed about your research/case to any lecturer of MSU?  </p>       </td>
	   ...
	   <legend><strong>Proposal Areas</strong></legend>	
        ...
        <?php
			...
			$rsGetJobArea = $db->query($sqlGetJobArea); echo $sqlGetJobArea;
