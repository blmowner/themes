...
<table>
	...
	<tr>
		...
		<td><textarea name="introduction" id="introduction" cols="30" class="ckeditor" rows="3" id="introduction" value="<?=$introduction?>"></textarea></td>
	</tr>
	<tr>
		<td><span style="color:#FF0000">*</span> Objective</td>
		<td><textarea name="objective" id="objective" cols="30" class="ckeditor" rows="3" value="<?=$objective?>"></textarea></td>
	</tr>
	<tr>
		<td><span style="color:#FF0000">*</span> Brief Description</td>
		<td><textarea name="description" id="description" cols="30" class="ckeditor" rows="3" value="<?=$description?>"></textarea></td>
	</tr>
</table>
<table>
	<tr>
   ...
   <fieldset style="width:800px">
					...
					<table border="1" cellpadding="3" cellspacing="3" width="78%" id="inputs9" class="thetable">
						<tr>
						  <th width="12%"><input type="checkbox" id="selectall_certificate" /></th>
							<th width="44%"><span class="labeling">File Name</span></th>
							<th width="44%"><span class="labeling">Upload File</span></th>
						</tr>
						...
						$sql="SELECT * FROM file_upload_proposal WHERE pg_proposal_id='$proposal_id' ";			
							...
							{ 
								...
								?><tr>
										...
										<td align="left"><input type="text" name="file_name[]" size="20" value="<?=$row["file_name"];?>" /></td>
										<td align="center"><input type="file" name="fileData[]" size="20" value="<?=$row["fu_document_filename"];?>"/></td>			
									</tr>
						<?	}							
						?>
     ...
     <table>
		<tr>
		  <td width="65"><input type="submit" name="btnSave" id="btnSave" align="center"  value="Submit"/></td>
			<td width="100"><input type="button" name="btnBack" value="Back" onclick="javascript:document.location.href='../student/student_programme.php';" /></td>		
		</tr>
