...
{	
	...
	{	
		...
		$sqlsubmit="INSERT INTO pg_proposal
				...
				'$discussion_status','$proposalRemarks','$thesis_id','SAV', 'OPN', '$curdatetime','$user_id','$curdatetime',
				'$user_id','$curdatetime') ";
...
?>
 	<fieldset>
		...
		<table>
			<tr>
				<td>Your thesis proposal has been save.</td>
			</tr>
		</table>
	</fieldset>	
	<?
...
if(isset($_POST['btnSubmit']) && ($_POST['btnSubmit'] <> ""))
{
	...
	{		
		...
		$sqlsubmit="INSERT INTO pg_proposal
				...
				pg_thesis_id, verified_status, status, report_date, insert_by,insert_date,modify_by,modify_date)
				VALUES('$proposal_id','$thesis_title','$thesis_type','$introduction','$objective','$description',
				'$discussion_status','$proposalRemarks','$thesis_id','INP', 'OPN', '$curdatetime','$user_id',
	   ...
	   <fieldset style="width:800px">
			   ...
			   <p>
						...
						<table>
							...
							<tr>
								<td><textarea name="proposalRemarks" class="ckeditor" cols="50" id="proposalRemarks"><?=$proposal_remarks;?></textarea></td>
							</tr>
						</table>
			</fieldset>
	   </div>
