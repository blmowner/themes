...
{	
	...
	if (sizeof($_POST['date']) > 0 ){
		for ($i=0; $i<sizeof($_POST['date']); $i++) {
			if (empty($_POST['date'][$i])) $msg[] = "<div class=\"error\"><span>Please select meeting date</span></div>";
			if ($_POST['meeting_time'][$i] == "") $msg[] = "<div class=\"error\"><span>Please select meeting time</span></div>";	
		}
	}
	...
	if(empty($msg)) 
	{
		...
		<fieldset>
			...
			<table>
				<tr>
					<td><label>Your thesis proposal has been saved successfully.</label></td>
				</tr>
			</table>
		</fieldset>
		<br/>
...
if(isset($_POST['btnSubmit']) && ($_POST['btnSubmit'] <> ""))
{
	...
	if(empty($_POST['introduction'])) $msg[] = "<div class=\"error\"><span>Please insert Introduction</span></div>";
			...
			for ($i=0; $i<sizeof($_POST['date']); $i++) {
				...
				$username = convertname($user_id);
					...
					else
					{
						...
						include("email_new_proposal.php");
					
					if ($ok) 
					{
						// email sent
						//$msg[] = "<div class=\"success\"><span>Email has been sent successfully!</span></div>";
					} 
					else 
					{
			...
			<table border="1" cellpadding="3" cellspacing="3" width="100%" id="inputs10" class="thetable">
				...
				<?php
					...
					$result = $db->query($sqlMeeting); //echo $sql;
						...
						{ 
							?><tr>
									<td align="center" width="30"><input type="checkbox" class="case_certificate" name="cbDelFile[]" value="<?=$row['id'];?>" /><input type="hidden" name="delFile[]" value="<?=$row['id'];?>" /></td>
									<td align="center" width="116"><label name="meeting_date[]" id="meeting_date<?=$row['id'];?>"></label><?=$row["date"];?></td>
									
									<td align="center" width="124">
									<select name="meeting_time" id="meeting_time<?=$row['id'];?>" size="1" >
									<?if ($row['time'] == "07:00 AM") {?><option value="07:00" selected = "selected">07:00 AM</option><?} else {?><option value="07:00">07:00 AM</option><?}?>									
									<?if ($row['time'] == "07:30 AM") {?><option value="07:30" selected = "selected">07:30 AM</option><?} else {?><option value="07:30">07:30 AM</option><?}?>									
									<?if ($row['time'] == "08:00 AM") {?><option value="08:00" selected = "selected">08:00 AM</option><?} else {?><option value="08:00">08:00 AM</option><?}?>									
									<?if ($row['time'] == "08:30 AM") {?><option value="08:30" selected = "selected">08:30 AM</option><?} else {?><option value="08:30">08:30 AM</option><?}?>									
									<?if ($row['time'] == "09:00 AM") {?><option value="09:00" selected = "selected">09:00 AM</option><?} else {?><option value="09:00">09:00 AM</option><?}?>									
									<?if ($row['time'] == "09:30 AM") {?><option value="09:30" selected = "selected">09:30 AM</option><?} else {?><option value="09:30">09:30 AM</option><?}?>									
									<?if ($row['time'] == "10:00 AM") {?><option value="10:00" selected = "selected">10:00 AM</option><?} else {?><option value="10:00">10:00 AM</option><?}?>									
									<?if ($row['time'] == "10:30 AM") {?><option value="10:30" selected = "selected">10:30 AM</option><?} else {?><option value="10:30">10:30 AM</option><?}?>									
									<?if ($row['time'] == "11:00 AM") {?><option value="11:00" selected = "selected">11:00 AM</option><?} else {?><option value="11:00">11:00 AM</option><?}?>									
									<?if ($row['time'] == "11:30 AM") {?><option value="11:30" selected = "selected">11:30 AM</option><?} else {?><option value="11:30">11:30 AM</option><?}?>									
									<?if ($row['time'] == "12:00 PM") {?><option value="12:00" selected = "selected">12:00 PM</option><?} else {?><option value="12:00">12:00 PM</option><?}?>									
									<?if ($row['time'] == "12:30 PM") {?><option value="12:30" selected = "selected">12:30 PM</option><?} else {?><option value="12:30">12:30 PM</option><?}?>									
									<?if ($row['time'] == "01:00 PM") {?><option value="13:00" selected = "selected">01:00 PM</option><?} else {?><option value="13:00">01:00 PM</option><?}?>									
									<?if ($row['time'] == "01:30 PM") {?><option value="13:30" selected = "selected">01:30 PM</option><?} else {?><option value="13:30">01:30 PM</option><?}?>									
									<?if ($row['time'] == "02:00 PM") {?><option value="14:00" selected = "selected">02:00 PM</option><?} else {?><option value="14:00">02:00 PM</option><?}?>									
									<?if ($row['time'] == "02:30 PM") {?><option value="14:30" selected = "selected">02:30 PM</option><?} else {?><option value="14:30">02:30 PM</option><?}?>									
									<?if ($row['time'] == "03:00 PM") {?><option value="15:00" selected = "selected">03:00 PM</option><?} else {?><option value="15:00">03:00 PM</option><?}?>									
									<?if ($row['time'] == "03:30 PM") {?><option value="15:30" selected = "selected">03:30 PM</option><?} else {?><option value="15:30">03:30 PM</option><?}?>									
									<?if ($row['time'] == "04:00 PM") {?><option value="16:00" selected = "selected">04:00 PM</option><?} else {?><option value="16:00">04:00 PM</option><?}?>									
									<?if ($row['time'] == "04:30 PM") {?><option value="16:30" selected = "selected">04:30 PM</option><?} else {?><option value="16:30">04:30 PM</option><?}?>									
									<?if ($row['time'] == "05:00 PM") {?><option value="17:00" selected = "selected">05:00 PM</option><?} else {?><option value="17:00">05:00 PM</option><?}?>									
									<?if ($row['time'] == "05:30 PM") {?><option value="17:30" selected = "selected">05:30 PM</option><?} else {?><option value="17:30">05:30 PM</option><?}?>									
									<?if ($row['time'] == "06:00 PM") {?><option value="18:00" selected = "selected">06:00 PM</option><?} else {?><option value="18:00">06:00 PM</option><?}?>									
									<?if ($row['time'] == "06:30 PM") {?><option value="18:30" selected = "selected">06:30 PM</option><?} else {?><option value="18:30">06:30 PM</option><?}?>									
									<?if ($row['time'] == "07:00 PM") {?><option value="19:00" selected = "selected">07:00 PM</option><?} else {?><option value="19:00">07:00 PM</option><?}?>									
									<?if ($row['time'] == "07:30 PM") {?><option value="19:30" selected = "selected">07:30 PM</option><?} else {?><option value="19:30">07:30 PM</option><?}?>									
									<?if ($row['time'] == "08:00 PM") {?><option value="20:00" selected = "selected">08:00 PM</option><?} else {?><option value="20:00">08:00 PM</option><?}?>									
									<?if ($row['time'] == "08:30 PM") {?><option value="20:30" selected = "selected">08:30 PM</option><?} else {?><option value="20:30">08:30 PM</option><?}?>									
									<?if ($row['time'] == "09:00 PM") {?><option value="21:00" selected = "selected">09:00 PM</option><?} else {?><option value="21:00">09:00 PM</option><?}?>									
									<?if ($row['time'] == "09:30 PM") {?><option value="21:30" selected = "selected">09:30 PM</option><?} else {?><option value="21:30">09:30 PM</option><?}?>									
									<?if ($row['time'] == "10:00 PM") {?><option value="22:00" selected = "selected">10:00 PM</option><?} else {?><option value="22:00">10:00 PM</option><?}?>									
									<?if ($row['time'] == "10:30 PM") {?><option value="22:30" selected = "selected">10:30 PM</option><?} else {?><option value="22:30">10:30 PM</option><?}?>									
									<?if ($row['time'] == "11:00 PM") {?><option value="23:00" selected = "selected">11:00 PM</option><?} else {?><option value="23:00">11:00 PM</option><?}?>									
									<?if ($row['time'] == "11:30 PM") {?><option value="23:30" selected = "selected">11:30 PM</option><?} else {?><option value="23:30">11:30 PM</option><?}?>									
									<?if ($row['time'] == "12:00 PM") {?><option value="24:00" selected = "selected">12:00 PM</option><?} else {?><option value="24:00">12:00 PM</option><?}?>																											
									</select></td>
									<td align="left" width="185"><input type="text" name="lecturer_name[]" id="lecturer_name<?=$row['id'];?>" value="<?=$row["lecturer_name"];?>"></text></td>
									<td align="left"><input type="text" name="remark[]" id="remark<?=$row['id'];?>" size="50" value="<?=$row["remark"];?>"></text></td>
									<td><a href="javascript:void(0)" onclick="updateMeeting('<?=$row['id'];?>');" class="update-certification upd_btn">Update</a></td>
								</tr>
						<?} ?> 	
			</table>
		</fieldset>
				...
				<?
					...
					{ 
						...
						?><tr>
								...
								<a href="../thesis/delete_attachment_proposal.php?fc=<?=$row["fu_cd"];?>&al=S" >
