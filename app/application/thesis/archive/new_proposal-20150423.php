...
<legend><strong>New Application - Outline of Proposed Research/Case Study</strong></legend>	
	<table>
	   ...
	   <table>
			<tr>
				<td><input type="button" name="btnDiscussionDetail" value="Discussion Detail" onclick="return newDicussion('<?=$proposal_id?>')" /></td>
				<td><input type="button" name="btnAttachment" value="Attachment" onclick="return newAttachment('<?=$proposal_id?>')" /></td>		
			</tr>
		</table>  
	   </div>			
  </fieldset>
