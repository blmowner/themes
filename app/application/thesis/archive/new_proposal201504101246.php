			...
			*/	
			...
			$username = convertname($user_id);
				...
				else
				{
					...
					include("../../../app/application/email/email_new_proposal.php");include("email_new_proposal.php");
...
<legend><strong>New Application - Outline of Proposed Research/Case Study</strong></legend>	
	<table>
	   ...
	   <table>
		<tr>
			<td><input type="button" name="btnDiscussionDetail" value="Discussion Detail" onclick="javascript:document.location.href='../thesis/new_proposal_discussion.php?pid=<?=$proposal_id?>';" /></td>
			<td><input type="button" name="btnAttachment" value="Attachment" onclick="javascript:document.location.href='../thesis/new_proposal_attachment.php?pid=<?=$proposal_id?>';" /></td>		
		</tr>
	</table>
