			...
			if ($row_cnt > 0) {
				...
				{ 
					?><tr>
							...
							<td align="center"><input type="text" name="meeting_date[]" id="meeting_date<?=$tmp_no;?>" value="<?=$row["date"];?>"></input></td>
				...
				?>
							...
							<td align="left"><input type="text" name="lecturer_name[]" id="lecturer_name" size="40" value="<?=$row["lecturer_name"];?>"></input></td>
							<td align="left"><textarea name="remark[]" id="remark" cols="45" value="<?=$row["remark"];?>"><?=$row["remark"];?></textarea></td>
