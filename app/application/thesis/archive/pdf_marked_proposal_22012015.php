...
while($dbIng->next_record())
{
	...
	$introduction = $dbIng->f("introduction");
	$objective = $dbIng->f("objective");
	$description = $dbIng->f("description");
	...
	array_push($setOfIngres, array($no,$studentName."-".$studentMatrixNo,$reportDate,$thesisId,$thesisDesc,$prep_thesis_title,$prep_introduction,$objective,$description,$proposalRemarks));
	$no++;
}
