				...
				<?  
					...
					?>
						<tr>
							...
							<td><label><a href="detail_proposal_history.php?pid=<?php echo $id;?>"</a><?=$id?></label></td>						
			...
			<?
				...
				doPages($perpage, 'proposal_history.php', $varParamSend, $a);					
					...
					<table>
						<tr>
							<td>
								<p>You don't have proposal/thesis history to view! You may need to create one.</p>
							</td>
						</tr>
					</table>
					<?
