				...
				<?  
					...
					?>
						<tr>
							...
							<td><label><a href="../thesis/detail_proposal_history.php?pid=<?=$id;?>"</a><?=$id?></label></td>						
			...
			<?
				...
				doPages($perpage, 'proposal_history.php', $varParamSend, $a);					
					...
					<table>
						<tr>
							<td>
								<p>You don't have proposal/thesis history to view! Please <a href="../thesis/new_proposal.php?pid=<?=$userid;?>">click here </a> to create a new one and submit. </p>
							</td>
						</tr>
					</table>
					<?
