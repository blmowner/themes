...
$sql = "select a.pg_thesis_id, a.id, DATE_FORMAT(a.report_date,'%d-%b-%Y') as report_date, a.thesis_title, a.thesis_type, 
		...
		a.verified_remarks, a.faculty_remarks_by, f.name as employee_name, DATE_FORMAT(a.faculty_remarks_date,'%d-%b-%Y') as remarks_date
		FROM pg_proposal a
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>  
		...
		<br/>	
		<fieldset>
		<legend><strong>Remark by Faculty</strong></legend>		
			<table>
				<tr>
					<td>Remark By</td>
					<td>:</td>
