...
<legend><strong>Cancel Application - Outline of Proposed Research/Case Study</strong></legend>	
  ...
  <?}
	...
	<fieldset>
		...
		<table>
			<tr>
				<td>Your cancellation request has been submitted to the Faculty successfully. Please <strong><a href="../student/student_programme.php?tid=<?=$thesis_id;?>&pid=<?=$proposal_id;?>"><img src="../images/click_here.jpg" width="60" height="30" style="border:0px;" title="Please click here"></a></strong> to return back to student profile.</td>
			</tr>
		</table>
	</fieldset>	
	<?
