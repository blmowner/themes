...
/*$sql2 = " SELECT a.pg_thesis_id , a.id, DATE_FORMAT(a.report_date,'%d-%b-%Y') AS theReportDate, a.thesis_title, a.thesis_type, 
		...
		ps.ref_supervisor_type_id,ps.skype_id,ps.expertise,ne.name as lecturer_name ,ne.empid as lecturer_id,
		ne.mobile,rst.description, a.endorsed_remarks
		FROM pg_proposal a
				...
				?>
					<tr>
					  <td align="center"><input name="myApprovalBox[]" type="checkbox" value="<?=$no;?>" /></td>	
						...
						<td>
						<?	$sqlSupervisor="SELECT ps.id, ps.ref_supervisor_type_id,ps.skype_id,ps.expertise,ne.name AS 
									name,ne.empid,
