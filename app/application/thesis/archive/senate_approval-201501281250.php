...
$sql2 = " SELECT a.pg_thesis_id , a.id, DATE_FORMAT(a.report_date,'%d-%b-%Y') AS theReportDate, a.thesis_title, a.thesis_type, 
		...
		a.verified_date, a.verified_remarks, a.status as endorsedStatus, a.discussion_status, a.proposal_remarks, 
		c.description AS endorsedDesc, d.student_matrix_no, e.name,
		a.endorsed_remarks
		FROM pg_proposal a
	...
	<body>  
		...
		if ($row_cnt>0) {?>	
			...
			<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1">
				...
				?>
					<tr>
						<? if ($endorsedStatus=='APP' || $endorsedStatus=='DIS'){
