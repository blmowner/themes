...
if(isset($_POST['btnSave']) && ($_POST['btnSave'] <> ""))
	{	
		...
		$sqlsubmit2="INSERT INTO pg_thesis(id,status, student_matrix_no,proposal_date,insert_by,insert_date, modify_by,modify_date,ref_thesis_status_id_proposal)
		 ...
		 $sqlsubmit="INSERT INTO pg_proposal(id,thesis_title,thesis_type,introduction,objective,description,insert_by,insert_date,modify_by,modify_date,discussion_status, pg_thesis_id, confirm_status, report_date)
