...
echo $proposal_status=$row_personal["proposal_status"];
	...
	{//echo "has record";
		...
		{ 
			...
			<?
				...
				<table>
						<tr>
							<td><strong>Note:</strong> Your thesis proposal is pending with Faculty for verification.</td>
						</tr>
					</table>
				</fieldset>
		<?	}
		...
		{ 
		 ...
		 <legend><strong>Verification by Faculty</strong></legend>
			...
			<table>
				<tr>
					<td><strong>Note:</strong> Your thesis proposal has been reviewed and require changes. Please <a href="edit_proposal.php?id=<?=$thesis_id;?>&pid=<?=$proposal_id;?>">click here </a> to update it and re-submit. </td>				
				</tr>
			</table>					
		</fieldset>
			<?
