				...
				<legend><strong>Endorsement by Senate</strong></legend>
					...
					<table>
						<tr>
							...
							{?>
								<td><strong>Note:</strong> Your thesis proposal has been approved by the Senate. You may need to <a href=""><img src="../images/click_here.jpg" width="60" height="30" style="border:0px;" title="Prepare and submit monthly progress report"></a> to prepare and then submit your monthly progress report.<br/>
									...
									$result = $db->query($sqlMeeting); //echo $sql;
										...
										{ 
											?><tr>
												...
												<a href="../thesis/delete_meeting_detail.php?id=<?=$row["id"];?>">
