		...
		{ 
		 ...
		 <legend><strong>Verification by Faculty</strong></legend>
			...
			<table>
				...
				<table>
					<tr>
						<td><input type="button" name="btnDiscussionDetail" value="Discussion Detail" onclick="javascript:document.location.href='../thesis/update_proposal_discussion.php?pid=<?=$proposal_id?>&tid=<?=$thesis_id?>';" /></td>
						<td><input type="button" name="btnAttachment" value="Attachment" onclick="javascript:document.location.href='../thesis/update_proposal_attachment.php?pid=<?=$proposal_id?>&tid=<?=$thesis_id?>';" /></td>		
					</tr>
				</table>
				</tr>
			</table>
