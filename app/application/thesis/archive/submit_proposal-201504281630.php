...
function respConfirm () {
    var confirmSubmit = confirm("Are you sure to submit? If yes click OK or otherwise click CANCEL to stay on the same page.");
		...
		{ 
		 ...
		 <legend><strong>Verification by Faculty</strong></legend>
			...
			<table>
				...
				<table>
					<tr>
						<td><input type="button" name="btnDiscussionDetail" value="Discussion Detail (<?=$row_cnt_discussion?>)" onclick="javascript:document.location.href='../thesis/update_proposal_discussion.php?pid=<?=$proposal_id?>&tid=<?=$thesis_id?>';" /></td>
						<td><input type="button" name="btnAttachment" value="Attachment (<?=$row_cnt_attachment?>)" onclick="javascript:document.location.href='../thesis/update_proposal_attachment.php?pid=<?=$proposal_id?>&tid=<?=$thesis_id?>';" /></td>		
					</tr>
				</table>
				</tr>
			</table>
