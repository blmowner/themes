...
{		
	...
	$sqlArea = "UPDATE pg_proposal_area
				SET job_id1_area = '$jobs_area1',
				job_id2_area = '$jobs_area2',
				job_id3_area = '$jobs_area3',
				job_id4_area = '$jobs_area4',
				job_id5_area = '$jobs_area5',
				job_id6_area = '$jobs_area6'
...
$sql_thesis="SELECT pt.id AS thesis_id, pt.student_matrix_no,pt.status as thesis_status,
				...
				AND pt.ref_thesis_status_id_proposal in ('INP','APP','APC','DIS')
				ORDER BY pt.id";
		...
		if ($proposal_status=='APP') 
		{
			...
			?>
				...
				<legend><strong>Endorsement by Senate</strong></legend>
					...
					<table>
						<tr>
							<?if ($proposal_status=='APP' && ($endorsed_status=='APP' || $endorsed_status=='APC'))
							{?>
		...
		{ 
		 ...
		 <legend><strong>Verification by Faculty</strong></legend>
			...
			<table>
					...
					<? echo $sqlPgProposalArea = "SELECT pg_proposal_id,job_id1_area,job_id2_area,job_id3_area,job_id4_area,job_id5_area,job_id6_area
					...
					<?php
						...
						<td width="70" nowrap><font color="#FF0000">*</font><b>Area 4</b></td>
						<td width="134">
					...
					<tr>
						<td width="70" nowrap><font color="#FF0000">*</font><b>Area 2</b></td>
						<td width="134">
					...
					<?php
						...
						<td width="70" nowrap><font color="#FF0000">*</font><b>Area 5</b></td>
						<td width="134">
					...
					<tr>
						<td width="70" nowrap><font color="#FF0000">*</font><b>Area 3</b></td>
						<td width="134">
					...
					<?php
						...
						<td width="70" nowrap><font color="#FF0000">*</font><b>Area 6</b></td>
						<td width="134">
