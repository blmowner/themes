...
<fieldset>
	...
	<tr>
	 ...
	 <? } elseif ($proposal_status=="Request with Changes" || $proposal_status=="INP"){?>
		<input type="button" name="btnEdit" id="btnEdit" value="Edit Thesis Proposal" onClick="javascript:window.open('edit_proposal.php?thesis_id='+document.form1.thesis_id.value,'aform','dependent=no,width=950,height=500,resizable=yes,scrollbars=yes');">
	 <? } else {}?>
		</td>
	</tr>
	</table>
...
<strong>  Outline of Proposed Research/Case Study</strong>
 <table>
    ...
    <tr>
      <td>Objective</td>
      <td><textarea name="objective" cols="30" class="ckeditor" rows="3" disabled="disabled"><?php echo $introduction; ?></textarea></td>
    </tr>
    <tr>
      <td>Brief Description of Research/Case Study </td>
      <td><textarea name="description" cols="30" class="ckeditor" rows="3" disabled="disabled"> <?php echo $introduction; ?></textarea></td>
    </tr>
  </table>
