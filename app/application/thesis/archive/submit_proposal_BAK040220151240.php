...
{		
	...
	echo $sqlUpdate4 = "UPDATE pg_proposal_area
				SET job_id1_area = '$jobs_area1'
	...
	{//echo "has record";
		...
		{ 
		 ...
		 <legend><strong>Verification by Faculty</strong></legend>
			...
			<table>
				<tr>
					<td><strong>Note: </strong>Your thesis proposal has been reviewed and require changes. Please <a href="edit_proposal.php?id=<?=$thesis_id;?>&pid=<?=$proposal_id;?>"><img src="../images/click_here.jpg" width="60" height="30" style="border:0px;" title="Please click here"></a>to update it and re-submit.</td>
				</tr>
			</table>					
			...
			<table>
					...
					<?//}?>
					<br/>
					<?						echo $sqlLookupJobArea = "SELECT jobarea, area
											FROM job_list_category
											ORDER By jobarea";?>
											
					<?echo $sqlPgProposalArea = "SELECT job_id1_area
		...
		<fieldset>
		 <legend><strong>Verification by Faculty</strong></legend>
			...
			<table>
				<tr>
					<td><strong>Note: </strong>Your thesis proposal has been disapproved by the Senate. You may need to <a href="../thesis/new_proposal.php?pid=<?php echo $userid;?>"><img src="../images/click_here.jpg" width="60" height="30" style="border:0px;" title="Please click here"></a> to create another one and re-submit.</td>
				</tr>
			</table>
		...
		<fieldset>
			...
			<table>
				<tr>			
					<td>You don't have a thesis proposal to view. Please <a href="../thesis/new_proposal.php?pid=<?=$userid;?>"><img src="../images/click_here.jpg" width="60" height="30" style="border:0px;" title="Plase click here"></a> to create a new one and submit. </td>							
