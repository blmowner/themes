...
if(isset($_POST['btnSubmit']) && ($_POST['btnSubmit'] <> "")) {
	...
	echo $sql1 = "UPDATE pg_proposal SET
				cancel_remarks='$cancelRemarks', cancel_date = '$currentDate', verified_status = 'WIT',	
...
$sql_thesis="SELECT pt.id AS thesis_id, pt.student_matrix_no,pt.status as thesis_status,
				...
				DATE_FORMAT(pp.report_date,'%d-%b-%Y') AS report_date, pp.cancel_remarks, 
				DATE_FORMAT(pp.cancel_date,'%d-%b-%Y %h:%i:%s') AS cancel_date
				FROM pg_thesis pt 
	...
	$cancelDate=$row_area['cancel_date'];
	$cancelRemarks=$row_area['cancel_remarks'];
...
<legend><strong>Cancel Application - Outline of Proposed Research/Case Study</strong></legend>	
	...
	<table>
     <tr>
		 ...
		 <? 
			...
			<table width="719" border="1" cellpadding="3" cellspacing="1" style="border-collapse:collapse;">
              <tr>
                ...
                <td width="240"><strong>Notes</strong></td>
              </tr>
              <?
  ...
  <?}
	...
	<fieldset>
		...
		<table>
			<tr>
				<td>Your cancellation request has been submitted to the Faculty successfully.</td>
			</tr>
		</table>
	</fieldset>	
	<?
