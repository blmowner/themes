	...
	<body>
		...
		<table width="100%" border="1" cellpadding="3" cellspacing="1" style="border-collapse:collapse;" class="thetable">
		  ...
		  <?
			...
			<table width="100%" border="1" cellpadding="3" cellspacing="1" style="border-collapse:collapse;" class="thetable">
              <tr>
                <th align="center" width="37"><strong>No</strong></th>
                <th width="192"><strong>Lecturer Name</strong></th>
				<th width="216"><strong>External Lecturer</strong></th>
                <th width="193"><strong>Meeting Mode</strong></th>
                <th width="170"><strong>Meeting Date</strong></th>
                <th width="146"><strong>Meeting Time</strong></th>
                <th width="278"><strong>Notes</strong></th>
              </tr>
              <?
				...
				if ($row_cnt2 > 0) {
					...
					do
					{
						...
						$remark=$dbb->f('remark'); 
						$meeting_mode=$dbb->f('description');
					?>
				  <tr>
		...
		<table>
			<tr>		
                ...
                <!--td><input type="button" name="btnBack" value="Print" onclick="javascript:document.location.href='../thesis/pdf_history_staff_detail.php?pid=<?=$id?>&matrix_no=<?=$matrix_no?>';" /></td-->		
			</tr>
		</table>
		</form>
	</body>
