		...
		else if(btnid == 'btnCancel4')//////////////////////////unselect area5
		{
			...
			{	
				if(txt4 == '')
				{
					...
					{
						alert("Please do selection for Thesis Proposal Thesis Proposal Area 5 first. Unselection is aborted.");
						return false;
					}
				}
				else
