...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>  
		...
		<input type="hidden" name="empid" id="empid" value="<?php echo $user_id; ?>">			
			...
			<fieldset>
			<legend><strong>List of Thesis Proposal - Disapproved Thesis by Senate</strong></legend><br/>	
			<table>
						<tr>							
		...
		<br />		
		<td><input type="button" name="btnPrintProposal" value="Print Listing" onclick="javascript:document.location.href='../thesis/pdf_thesis_approval.php?smd=<?=$searchRequestDate?>';" /> </td><br/>
		<br />	
