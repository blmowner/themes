...
require("../../../lib/fpdf/senate_approval_table2.php");
...
$varColWidth=array(7,45,20,18,22,18,59,38);
...
//}
	...
	{*/
		...
		while($db->next_record())
		{
			...
			$pdf->Ln();
			$pdf->Cell(5,4,'',0,0,'L');
			$pdf->Cell(30,4,'Introduction',0,0,'L');
			$pdf->Cell(2,4,'',0,0,'L');		
			$pdf->SetFont('Arial','',9);
			$pdf->Cell(2,4,':',0,0,'L');
			$pdf->MultiCell(212,4,$introduction,0,'L');
			...
			//$pdf->Ln();
			$pdf->Cell(5,4,'',0,0,'L');
			$pdf->Cell(30,4,'Objective',0,0,'L');
			$pdf->Cell(2,4,'',0,0,'L');		
			$pdf->SetFont('Arial','',9);
			$pdf->Cell(2,4,':',0,0,'L');
			$pdf->MultiCell(212,4,$objective,0,'L');
			...
			$pdf->MultiCell(212,4,$description,0,'L');
