...
require("../../../lib/fpdf/senate_disapproval_table.php");
...
$varHeader=array("No","Thesis/Project ID","Thesis/Project Title","Student Name", "Matric No","Verified by Faculty","Decision by Senate");
...
$result_sqlSupervisor = $dbf->query($sqlSupervisor);	
$row_cnt = mysql_num_rows($result_sqlSupervisor);							
$no1=1;
$super = "";
while($dbf->next_record()) 
{
	$empid=$dbf->f('pg_employee_empid');
...
//------------
		...
		$endorsed1 = 'Disapproved';
		array_push($setOfIngres, array($no,$pgThesisId,$thesisTitle,$studentName,$studentMatrixNo,$verifiedDesc,$endorsedDesc));	
		$no++;
	}
