...
// Program Name: proposal_history_admin.php
//
// Created by: Zuraimi
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		?>			
				...
				<?
				$sql2 = "SELECT d.student_matrix_no, e.name, a.pg_thesis_id, a.id, DATE_FORMAT(a.modify_date,'%d-%b-%Y %h:%i:%s %p') AS theModifiedDate,  	
		...
		{
				$sql3 = "SELECT d.student_matrix_no, e.name, a.pg_thesis_id, a.id, DATE_FORMAT(a.modify_date,'%d-%b-%Y %h:%i:%s %p') AS theModifiedDate, 	
