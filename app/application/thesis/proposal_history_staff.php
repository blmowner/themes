...
$sql1 = "SELECT DISTINCT d.student_matrix_no
		FROM pg_proposal a
		...
		ORDER BY d.student_matrix_no DESC
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		{
			$sql2 = "SELECT d.student_matrix_no, a.pg_thesis_id, a.id, DATE_FORMAT(a.modify_date,'%d-%b-%Y %h:%i %p') AS theModifiedDate,  	
			...
			a.verified_status, a.status, a.discussion_status, c1.description AS verified_desc, 
			...
			<tr>
				...
				<th width="200"><strong>Student Name</strong></h>
				...
				<th width="139"><strong>Modification Date</strong></th>
				<th width="97"><strong>Faculty Status</strong></th>	
				<th width="95"><strong>Senate Status</strong></th>	
				<th width="95"><strong>Archived Status</strong></th>						
			</tr>
			<?
			if ($row_cnt>0) {
				$no=1;
		...
		else //if ($studentMatrixNo2!='All' || $studentMatrixNo2<>'')
		{
				...
				<tr>
					<th width="24"><strong>No.</strong></th>
					<th width="200"><strong>Student Name</strong></th>
					<th width="120"><strong>Thesis/Project ID</strong></th>
					<th width="91"><strong>Proposal ID</strong></th>						
					<th width="263"><strong>Thesis/Project Title</strong></th>
					<th width="139"><strong>Modification Date</strong></th>
