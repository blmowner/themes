...
if(isset($_POST['btnSave']) && ($_POST['btnSave'] <> "")) {
	...
	$msg = array();
	if (empty($_POST['endorsedRemarks'])) $msg[] = "<div class=\"error\"><span>Please enter your remarks as required below.</span></div>";
	if(empty($msg)) 
	{
...
?>	
		...
		<table width="100%" border="1" cellpadding="3" cellspacing="1" style="border-collapse:collapse;" class="thetable">
		  ...
		  <?
			...
			<fieldset>
			    ...
			    <table width="100%" border="1" cellpadding="3" cellspacing="1" style="border-collapse:collapse;" class="thetable">
                  <tr>
                    <th width="37" align="center"><strong>No</strong></th>
                    <th width="205"><strong>Lecturer Name</strong></th>
                    <th width="203"><strong>External Lecturer</strong></th>
                    <th width="192"><strong>Meeting Mode</strong></th>
                    <th width="162"><strong>Meeting Date</strong></th>
                    <th width="149"><strong>Meeting Time</strong></th>
                    <th width="282"><strong>Notes</strong></th>
                  </tr>
                  <?
				...
				if ($row_cnt>0) {
					...
					?>
                  <tr>
                    <td align="center"><label name="no" size="3" id="no" >
                      <?=$no?>
                      .</label></td>
                    <td><label name="lecturerName" size="15" id="lecturerName" >
                      <?=$lecturerName?>
                    </label></td>
                    <td><label name="externalLecturer" size="15" id="externalLecturer" >
                      <?=$externalLecturer?>
                    </label></td>
                    <td><label name="meetingmode" size="25" id="meetingmode" >
                      <?=$meeting_mode?>
                    </label></td>
                    <td><label name="theMeetingDate" size="25" id="theMeetingDate" >
                      <?=$theMeetingDate?>
                    </label></td>
                    <td><label name="theMeetingSTime" size="25" id="theMeetingSTime" >
                      <?=$theMeetingSTime?>
                    </label></td>
                    <td><label name="remark" cols="20" disabled="disabled" id="remark">
                      <?=$remark?>
                    </label></td>
                  </tr>
                  <?
		...
		<br/>
		<fieldset>
		<legend><strong>Individual Remarks by Senate <span style="color:#FF0000">*</span></strong></legend>
		<tr>
		...
		<table>
		<tr>
			<td><input type="submit" name="btnSave" id="btnSave" value="Update" /></td>	
