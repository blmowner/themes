...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>  
		...
		<table>
			<tr>
				<td><label><strong>Proposal Area</strong></label></td>
			</tr>
		</table>
		<table width="100%" border="1" cellpadding="3" cellspacing="1" style="border-collapse:collapse;" class="thetable">
		  ...
		  <?
			...
			<table>
			<tr>
				<td><label><strong>Discussion Detail</strong></label></td>
			</tr>
		</table>
		<table width="100%" border="1" cellpadding="3" cellspacing="1" style="border-collapse:collapse;" class="thetable">
			  <tr>
		...
		<br/>
		<fieldset>
		<legend><strong>Individual Remarks by Senate</strong></legend>
		<tr>
		...
		<table>
		<tr>
			<td><input type="button" name="btnBack" value="Back" onclick="javascript:document.location.href='senate_approval_detail.php?aid=<?=$approvalId?>';" /></td>			
		</tr>	
	</table>
	<br/>
	  </form>
