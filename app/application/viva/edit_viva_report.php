	...
	<form id="form1" name="form1" method="post" enctype="multipart/form-data">	
			...
			<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="80%" class="thetable">
              ...
              <tr>
                ...
                <td align="left"><? if($report_status == 'SUB') {?>
                    <a href="view_edit_viva_report_staff.php?tid=<?=$thesisId?>&type=<?=$ref_supervisor_type_id?>&mn=<?=$matrixNo?>&role=<?=$role_status?>&pd=<?=$otherDetailId?>&empid=<?=$employeeId?>&other=<?=$pd?>&othertype=<?=$roleType?>" name="thesisId" value="<?=$thesisId?>" title="View feedback"><img src="../images/view.jpg" width="45" height="30" style="border:0px;" title="View feedback" /></a>
                    <? } ?></td>
              </tr>
...
?>
	...
	<table class="thetable" border="1" width="67%">
