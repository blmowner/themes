...
$sql_thesis = "SELECT thesis_title FROM pg_proposal where pg_thesis_id = '$thesisId'";
$dbgThesis = $dbg;
$result_sql_thesis = $dbgThesis->query($sql_thesis); 
$dbgThesis->next_record();
$row_cnt_thesis = mysql_num_rows($result_sql_thesis);
$thesis_title = $dbgThesis->f('thesis_title');
?>
	...
	<form id="form1" name="form1" method="post" enctype="multipart/form-data">
		<div style="margin-left:25px;">
			...
			<table width="54%">
				...
				<tr>
					<td width="31%"><strong>Reference No</strong></td>
					<td width="3%">:</td>
					<td width="66%"><?=$referenceNo?></td>
				</tr>
				<tr>
...
?>
	...
	<table width="95%" class="" border="1" style="border-collapse: collapse;border-spacing: 0px;">
		<tr>
			...
			<th align="left" width="21%">Feedback of External Examiner</th>
			<th align="left"width="33%">Amendmenst Based on the comment<br />
		  from External Examiner<br />(Please specify the page number)</th>
			<th width="29%" align="left">Confirmation from Supervisor/Co-Supervisor on Amendment of thesis </th>
			<th width="13%">Verify By
		...
		<? if($row_cnt5>0) {?>
			...
			$amendStat = $dbb->f('amendStat');
				...
				$sql_name_sp = "SELECT name from new_employee where empid = '$user_id'";
				$dbc1 = $dbc;
