...
if(isset($_POST['btnsave']) && ($_POST['btnsave'] <> ""))
{
	...
	$pgVivaDetailId=$_GET['pgVivaDetailId'];
	...
	$save = "1";
	echo "<script>window.location = 'review_viva_edit_thesis.php?tid=".$thesisId."&pid".$proposalId."&save=".$save."';</script>";		
...
$sql_viva = "SELECT id from pg_viva_detail
	...
	<form id="form1" name="form1" method="post" enctype="multipart/form-data">	
			...
			<table width="52%">
				...
				<tr>
					...
					<input type="hidden" name="pgVivaDetailId" id="pgVivaDetailId" value="<?=$pgVivaDetailId; ?>">pgVivaDetailId
				</tr>
				<tr>
...
?>
	...
	<table>
		<tr>
			<td>Comment:</td>
			<td><textarea class="ckeditor" name="comment" id="comment"></textarea></td>
		</tr>
	</table>
