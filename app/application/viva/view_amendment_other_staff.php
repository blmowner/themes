...
?>
	...
	<table width="95%" class="thetable" border="1">
		...
		<? if($row_cnt5>0) {?>
			...
			AND a.empid = '$empid'
			AND b.pg_amendment_id = '$amendmentId'
	...
	<table>
		<tr>
		  <td colspan="2">
		  <input type="button" name="btnBack" id="btnBack" value="Back" onClick="javascript:document.location.href='review_amendment_staff.php';"/>
		</tr>
	</table>	
