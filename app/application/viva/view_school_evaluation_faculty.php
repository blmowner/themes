...
<? } ?>
	...
	<form id="form1" name="form1" method="post" enctype="multipart/form-data">	
			<table border="0"> 
				<tr>
				<td><h3><strong>VIVA School Board Comittee</strong><h3></td>
				</tr>
			</table>
			<table width="52%">
				<!--<tr>
			...
			<table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="90%" class="thetable">
              ...
              <tr>
				...
				<? if($report_status == 'SUB') {?>
                    <a href="view_school_other_fac.php?tid=<?=$thesisId?>&type=<?=$ref_supervisor_type_id?>&mn=<?=$matrixNo?>&role=<?=$role_status?>&pd=<?=$otherDetailId?>&empid=<?=$employeeId?>&other=<?=$evaluationId?>&othertype=<?=$roleType?>" name="thesisId" value="<?=$thesisId?>" title="View feedback"><img src="../images/view.jpg" width="45" height="30" style="border:0px;" title="View feedback" /></a>
                    <? } ?>
				</td>
              </tr>
...
?>
	...
	<table>
		<tr>
		  <td colspan="2">
		  <input type="button" name="btnBack" id="btnBack" value="Back" onClick="javascript:document.location.href='viva_school_faculty.php';"/>
