...
?>
	...
	<table>
		...
		<tr>
		  <td colspan="2">	  
		  <input type="button" name="btnBack" id="btnBack" value="Back" onClick="javascript:document.location.href='view_school_evaluation_faculty.php?tid=<?=$thesisId?>&pid=<?=$proposalId[$j]?>&mn=<?=$matrixNo?>&ed=<?=$other?>';"/>
