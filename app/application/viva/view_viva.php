...
AND (submit_status IN ('SAV', 'SUB', 'REQ', 'CON') OR submit_status IS NULL)
AND id = '$vivaId'
						...
						do {
							...
							<tr>
								...
								*/
								...
								<td><a href="../viva/view_viva_feedback_com.php?tid=<?=$thesisId;?>&pid=<?=$proposalId;?>&empid=<?=$employeeId;?>&mn=<?=$user_id?>&vd=<?=$pgVivaDetailId?>&vid=<?=$vivaId?>" name="thesisId" value="<?=$thesisId?>" title="View feedback"><img src="../images/view.jpg" width="45" height="30" style="border:0px;" title="View feedback"></a></td>
