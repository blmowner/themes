					...
					if ($row_cnt_supervisor>0) {
						do {
							...
							<tr>
								...
								WHERE a.student_matrix_no = '$empid'
								...
								*/
								...
								<!--<td><a href="../defense/defense_view_feedback.php?tid=<? echo $thesisId;?>&amp;pid=<? echo $proposalId;?>&amp;eid=<? echo $employeeId;?>&amp;id=<? echo $id;?>&amp;mn=<?=$empid?>" name="thesisId" value="<?=$thesisId?>" title="View feedback"><img src="../images/view.jpg" width="45" height="30" style="border:0px;" title="View feedback"></a></td>-->	
								<?}
								else {
									?>
									<!--<td></td>-->
...
<? 
	...
	WHERE a.pg_student_matrix_no = '$empid'
...
?>
	...
	<table>
		<tr>
		  ...
		  <input type="button" name="btnBack" id="btnBack" value="Back" onClick="javascript:document.location.href='edit_viva.php?tid=<?=$pgThesisId?>&pid=<?=$proposalId?>&vid=<?=$pgVivaId?>';"/>
</td>
