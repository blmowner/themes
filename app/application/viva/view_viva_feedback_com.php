...
?>
	...
	<table>
		<tr>
		  ...
		  <input type="button" name="btnBack" id="btnBack" value="Back" onClick="javascript:document.location.href='view_viva.php?tid=<?=$pgThesisId?>&pid=<?=$proposalId?>&vid=<?=$pgVivaId?>';"/>
</td>
