...
?>
	...
	<table width="100">
		<tr>
			<td width = "250"><strong>Comment</strong></td>
		</tr>
		<tr>
...
?>
	...
	<table>
		<tr>
		  ...
		  <input type="button" name="btnBack" id="btnBack" value="Back" onClick="javascript:document.location.href='view_viva_result.php?tid=<?=$pgThesisId?>&pid=<?=$proposalId?>&vid=<?=$pgVivaId?>';"/>
</td>
