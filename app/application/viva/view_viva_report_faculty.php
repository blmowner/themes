...
?>
	<table>
		...
		<tr>
		  <td colspan="2">	  
		  <input type="button" name="btnBack" id="btnBack" value="Back" onClick="javascript:document.location.href='appeal_review_view.php?tid=<?=$pgThesisId?>&aid=<?=$appealId?>&mn=<?=$matrixNo?>&vid=<?=$pgVivaId?>';"/>
