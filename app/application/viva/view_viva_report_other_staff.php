...
?>
	...
	<table>
		...
		<tr>
		    ...
		    <td colspan="3">
		 <?   
		 if($othertype=='EC' || $othertype=='CC') {
		 $othertype = $_REQUEST['othertype'];?>
		   <input type="button" name="btnBack" id="btnBack" value="Back" onClick="javascript:document.location.href='view_viva_report.php?tid=<?=$thesisId?>&mn=<?=$matrixNo?>&role=<?=$rolestatus?>&pd=<?=$other?>&type=<?=$othertype?>';"/>
