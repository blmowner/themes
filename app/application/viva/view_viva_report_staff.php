...
?>
	...
	<table>
		...
		<tr>
		  ...
		  <input type="button" name="btnBack" id="btnBack" value="Back" onClick="javascript:document.location.href='new_viva_report.php?tid=<?=$thesisId?>&mn=<?=$matrixNo?>&role=<?=$rolestatus?>&pd=<?=$other?>&type=<?=$othertype?>';"/>
