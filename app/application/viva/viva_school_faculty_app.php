...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<legend><strong>List of VIVA Result </strong></legend>
		...
		<table>
			<tr>							
				...
				1. Only Main Supervisor can recommend for Proposal Defence Date.<br/>
				2. Please recommend at least 1 date to enable your supervisee to submit the defence proposal.</td>
			</tr>
		</table>
		<br/>
		<table>
	    ...
	    <table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="95%" class="thetable">
          <tr>
            ...
            <th width="12%" align="left">Thesis / Project ID</th>
            <!--<th width="7%" align="left">Thesis Title</th>-->
            <th width="18%" align="left">Student Name (Student Matrix No)</th>
            <th width="23%" align="left">Session Date</th>
            <th width="16%" align="left">Result Status </th>
            <th width="18%" align="left">Final Result Status </th>
          ...
          <tr>
            ...
            <td align="left"><?=$defenseDateArray?>
              ...
              <?=$venueArray?></td>
            <!--$modify_date[$j]-->
            <td width="16%" align="left"><?=$resultDesc[$j]?></td>
            <td width="18%"align="left"><?=$descriptionF?></td>
            <td width="7%" align="center"><input type="button" name="btnView" id="btnView" value="View" 
	...
	<table>
		<tr>
		  <td><input type="submit" name="submit" value="Print" onclick="javascript:open_win('print_all_eva_faculty.php',1000,760,0,0,0,1,0,1,1,0,5,'winupload'); "/></td>	  
		</tr>
	</table>
	</fieldset>			
</body>
