...
// Program Name: new_work_view_feedback.php
//
// Created by: Zuraimi
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function respConfirm () {
		...
		<table>
			<tr>
				<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../work/new_work.php?pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&id=<?=$workId;?>&ref=<?=$referenceNo;?>';" /></td>
			</tr>
		</table>
		</br>
		</form>
