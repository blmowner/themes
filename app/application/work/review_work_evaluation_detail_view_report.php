...
if(isset($_POST['btnSave']) && ($_POST['btnSave'] <> ""))
{
	...
	if(empty($msg)) 
	{
		if ($evaluationDetailStatus=="IN1") {
			...
			$msg[] = "<div class=\"success\"><span>Defence Proposal Evaluation Report has been saved successfully.</span></div>";	
		}	
	...
	if(empty($msg)) 
	{
		if ($evaluationDetailStatus=="IN1") {
			...
			if ($supervisorTypeId =="EC") {
				...
				SET ref_work_marks_id = '$defenseMarksCb', status = 'REC',
			...
			$sql13 = "UPDATE pg_work_evaluation_detail
			SET major_revision = '$majorRevision', other_comment = '$otherComments', responded_date = '$curdatetime',
			ref_work_marks_id = '$defenseMarksCb', status = 'REC', modify_by = '$user_id', modify_date = '$curdatetime'
			WHERE id = '$evaluationDetailId'
			AND pg_eval_id = '$evaluationId'
			AND pg_employee_empid = '$user_id'
			AND status = 'SV1'
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script language="JavaScript" type="text/javascript" src="../../../lib/js/tooltip.js"></script></head>
<style type="text/css">
...
<table border="0">
		...
		<table width="950" border="1">
			<tr>
				<td><strong><font size="5">WORK COMPLETION SEMINAR EVALUATION </font></strong></td>
			</tr>
  </table>
		<p><strong><i>(To be fill in by Panel Committee)</i></strong></p>
		...
		<input type="hidden" name="sname" id="sname" value="<?=$sname; ?>">
			...
			<tr>
				<th align="left">Matrix Number</th>
				<td colspan ="3"><?=$studentMatrixNo?><input type="hidden" name = "studentID" id = "studentID" value="<?=$studentMatrixNo?>" /></td>
			</tr>
		
			<tr>
				<th align="left">Programme</th>
				<td width="786"><input type="hidden" name="program_code" size="15" id="program_code" value="<?=$program_code?>" disabled="disabled"/><?=$program_code?> - <input type="hidden" name="program_e" size="30" id="program_e" value="<?=$program_e?>" disabled="disabled"/><?=$program_e?></td>
			</tr>
			<tr>
				<th align="left">Title of Thesis</th>
		...
		<tr>
			<th align="left">Date of Work Completion Seminar</th>
			<td colspan = "3"><?=$defenseDate?></td>
	    <tr>
			<th width="191"><p align="left">Name of 1. Supervisor and 2. Co. Supervisor</p></th>
			<td colspan = "3">	<?php				
				...
				$varRecCount=0;	
					...
					{ 
						...
						$svname=$row_supervise["name"];
						$svid=$row_supervise["id"];
...
<fieldset>
		<legend><font size="4"><strong>SECTION A: OVERALL STYLE AND ORGANIZATION</strong></font></legend>
		<table>
		...
		<table width="85%" border="1" cellpadding="3" cellspacing="1" style="border-collapse:collapse;" class="thetable">			
			...
			for ($j=0;$j<$row_cnt14;$j++) {
				...
				<tr>
					...
					AND status = 'A'								
					ORDER BY seq";
					$overallStyleRatingStatusArray[$j];
			...
			<br />
			<fieldset><legend><font size="3"><strong>SECTION B: MAJOR REVISION REQUIRED (<em>if any</em>)</strong></font></legend>
	...
	<fieldset><legend><font size="3"><strong> <label>SECTION C: OTHER COMMENTS</label></strong></font></legend>
...
<fieldset><legend><font size="3"><strong> <label>SECTION D: RECOMMENDATION</label></strong></font></legend>
...
<br />
<fieldset><legend><font size="3"><strong> <label>SECTION E:OVERALL COMMENT ON STUDENT</label></strong></font></legend>

<p><STRONG>As supervisor, how do you assess your student on the following grounds? Please rate how strongly you agree or disagree with the statement about the candidate on the following ground.</STRONG></p>
...
<tr>
	<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../defense/defence_proposal_evaluate.php';" /></td>			
 	<td><input type="button" name="btnPrint" value="Print me" onClick="javascript:document.location.href='../work/pdf_work_completion_report.php?id=<?=$id?>&mn=<?=$studentMatrixNo?>&tid=<?=$thesisId?>&pid=<?=$proposalId?>&ref=<?=$referenceNo?>&refd=<?=$referenceNoDefence?>&rol=<?=$supervisorTypeId?>&cid=<?=$calendarId?>&did=<?=$defenseId?>';" /></td>
