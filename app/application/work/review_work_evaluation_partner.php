...
// Program Name: review_work_evaluation_partner.php
//
// Created by: Zuraimi
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table>
		<tr>
			<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../work/review_work_evaluation_detail.php?id=<?=$evaluationId?>&cid=<?=$calendarId?>&mn=<?=$studentMatrixNo?>&tid=<?=$thesisId?>&pid=<?=$proposalId?>&ref=<?=$referenceNo?>&refd=<?=$referenceNoDefence?>&rol=<?=$supervisorTypeId?>';" /></td>
		</tr>
	</table>
