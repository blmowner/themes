...
if(isset($_POST['btnSearch']) && ($_POST['btnSearch'] <> "")) {
	...
	if ($row_cnt == 0) {
		$msg[] = "<div class=\"error\"><span>No record has been found!</span></div>";
	}
}
else {
	$row_cnt = 0;
...
<?php
	...
	<table>
		...
		<tr>
			...
			<input type="submit" name="btnSearch" value="Search" class="fancy-button-blue" /><span style="color:#FF0000"> Note:</span> If no entry is provided, it will search all.</td>
		</tr>
