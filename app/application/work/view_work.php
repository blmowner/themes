...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<form id="form1" name="form1" method="post" enctype="multipart/form-data">	
		<table border="0">
			<tr>
			<td><h3><strong>Work Completion Details - VIEW</strong><h3></td>
			</tr>
		</table>
		<table>
			<tr>
				...
				if ($row_cnt_supervisor>0) {
					do {
						...
						<tr>
							...
							if ($row_cnt12>0) {
								?>
								<td align="center"><a href="view_work_view_feedback.php?tid=<?=$thesisId;?>&pid=<?=$proposalId;?>&eid=<?=$employeeId;?>&id=<?=$id;?>&ref=<?=$referenceNo;?>&cid=<?=$calendarId?>">View</a></td>	
								<?}
								else {
									?>
									<td></td>
