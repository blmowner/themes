...
// Program Name: work_review_amendment_view.php
//
// Created by: Zuraimi
	  ...
	  <table>
       ...
       <table border="1" style="border-collapse:collapse;" cellpadding="2" cellspacing="1" width="90%" class="thetable">
        <tr>
		  ...
		  <th width="25%" align="left">Comment by Supervisor</th>
		</tr>  
		<? 
		if ($row_cnt1 > 0) {		
			for ($j=0; $j<$row_cnt1; $j++){	?>
				...
				<tr class="<?=$color?>">					
					...
					<td><em><?=$commentDateArray[$j]?></em><br><?=$commentSVArray[$j]?></td>
				</tr>		
			<? }			
		}		
		else {
