...
// Program Name: work_view_feedback.php
//
// Created by: Zuraimi
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function respConfirm () {
		...
		<table>
			<tr>
				<td><input type="button" name="btnBack" value="Back" onClick="javascript:document.location.href='../work/review_work_detail_view.php?pid=<?=$proposalId;?>&tid=<?=$thesisId;?>&id=<?=$defenseId;?>&mn=<?=$studentMatrixNo;?>&ref=<?=$referenceNo;?>&cid=<?=$calendarId;?>';" /></td>
			</tr>
		</table>
		</br>
		</form>
