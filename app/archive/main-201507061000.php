...
<div id="wrapper"><!-- content wrapper -->
    ...
    <div id="header"  class="inline-ul"><!-- header -->
        ...
        <span class="display_name">
			...
			$sqlstd="SELECT CHAR_LENGTH(staff_id) as total, SUBSTR(staff_id,1,2) as prefix
            ...
            Last Login: <?php echo getValue_local('user_last_login','user_acc','staff_id',$_SESSION['user_id']); ?><br class="clear" />
