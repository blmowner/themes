...
{ 
    ...
    if($_POST['submit'] <> "") {
        ...
        if(empty($msg)) 
		{
				$sql2 = "INSERT INTO pg_publication (`issn_no`,`insert_by`,`insert_date`,status) 
				VALUES ('$issn','$user_id', '$curdatetime', '$status')";
				$db->query($sql2);

                                
                $msg[] = "<div class=\"success\"><span>ISSN No successfully added!</span></div>";
...
<body>
    <div class="padding-5 margin-5 outer">
		...
		<table>
			<tr>
			  <td width="223">* ISSN No</td>
			  <td width="493"><input type="text" name="issn" size="40" value="" /></td>
			</tr>
			<tr>
