    ...
    if($_POST['btnUpdate'] <> ""){
		...
		{	
			...
			$sqltracking = "INSERT INTO pg_announcement_tracking
					...
					VALUES
					('$trackId', 'E', '$user_id', '".$lol."' , '$Aid', 'A', '$curdatetime', '$newStartDate', '$newEndDate' , 'D')";
...
<form method="post" id="form-set">
	<table>
		...
		<tr>
			...
			<td style="background-color: rgba(33, 26, 16, 0.3); "><input type="text" name="start_date" id="start_date" maxlength="50" readonly="" value="<?=$startDate?>"/></td>
			...
			<td style="background-color: rgba(33, 26, 16, 0.3); "><input type="text" name="end_date" id="end_date" maxlength="50" readonly="" value="<?=$endDate?>"/></td>
				<?	$jscript .= "\n" . '$( "#end_date" ).datepicker({
												changeMonth: true,
												changeYear: true,
												yearRange: \'-100:+0\',
		...
		<tr>
			...
			<input type="submit" id="btnUpdate" name="btnUpdate" value = "Publish" /></td>
		</tr>
