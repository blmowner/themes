...
if(isset($_POST['btnSearch']) && ($_POST['btnSearch'] <> "")) {
	...
	if ($publish_by!="") 
	{
		$tmpSearchPublishBy= " AND a.announcer = '$publish_by'";
	}
	else 
	{
		$tmpSearchPublishBy="";
	...
	.$tmpSearchEndDate." "
	.$tmpSearchtitle." "." 
	ORDER BY a.insert_date DESC, a.ref_no
	";
...
?>
	...
	<table>
		...
		<tr>
			<td>Publish By<br>(Employee Id)</td>
			<td><span style="font-size:14px">:</span><input type="text" id="publish_by" name="publish_by" value="" /></td>
		</tr>
		<tr>
			<td>Start Date </td>
			<td><span style="font-size:14px">:</span><input type="text" id="start_date" name="start_date" value="" /></td>
		...
		<tr>
			<td>End Date </td>
			<td><span style="font-size:14px">:</span><input type="text" id="end_date" name="end_date" value="" /></td>
				<?	$jscript .= "\n" . '$( "#end_date" ).datepicker({
												changeMonth: true,
												changeYear: true,
												yearRange: \'-100:+0\',
	...
	<div class = "viewA" style="overflow:auto; height: 300px;">
      <table width="1065" border="1" class = "thetable"><!--thetable2-->
        <tr>
		  <th width="60">Tick</th>
		  <!--<th width="128"> ID</th>-->
        ...
        <tr class="<?=$color?>">
		  ...
		  <!--<td><?=$idArray[$i]?></td>-->
          <td><?=$titleArray[$i]?></td> 
		  <td align="center"><?=$empName?><br>(<?=$announcerArray[$i]?>)</td>
		  ...
		  <td align="center">
		  <? if($publishStatusIdArray[$i] == 'S') {?>
		  <button class="editAnnoun" id="editAnnoun" name="editAnnoun" style = "width:80px;" href="edit_announ_admin.php?id=<?=$idArray[$i]?>">Edit</button><!-- btn btn-primary btn-xs-->
		  <? } else {?>  <button class="editAnnoun" id="editAnnoun" name="editAnnoun" style = "width:80px;" href="view_announ_admin.php?id=<?=$idArray[$i]?>">View</button>
	...
	<?	}*/
		...
		<table>
		<tr>
		  <td colspan="6" align="left"><input type="submit" name="btndelete" id="btndelete" value="Delete" style = "width:80px;" onclick="return deleteReport()" /></td><!--btn btn-danger btn-xs-->
		</tr>
