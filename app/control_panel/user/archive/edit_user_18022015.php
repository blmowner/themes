<?php 
    ...
    if($_POST['submit'] <> "") {
        ...
        if(empty($msg)) {
            ...
            $sqlUpd = "UPDATE user_acc SET role_id='$role', user_status='$status', modify_by='".$_SESSION['user_id']."', modify_date=now() WHERE staff_id='$userId'";
...
?>
    ...
    <form method="post" id="form-set">
        <label class="labeling"><?php echo load_lang('name'); ?></label><?php echo getValue('name','employee','empid',$userId); ?><br /><br />
