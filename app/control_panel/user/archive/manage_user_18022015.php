...
<div class="padding-5 margin-5 outer">
    ...
    <?php
        ...
        $sql = "SELECT a.staff_id, c.role_type, b.name, b.dept_id, a.user_online_stat, a.user_status, a.user_last_login, a.user_ip
                FROM user_acc a 
    ...
    ?>
        <tr class="<?php echo $color; ?>">
            ...
            <td align="center"><?php echo $db->f('dept_id'); ?></td>
            <td align="center">
            <?php 
    ...
    <?php
        ...
        $count_total_result = "SELECT a.staff_id, c.role_type, b.name, b.dept_id, a.user_online_stat, a.user_status, a.user_last_login, a.user_ip
                FROM user_acc a 
               /*LEFT JOIN employee b ON (b.empid = a.staff_id)*/
                LEFT JOIN base_user_role c ON (a.role_id = c.role_id) 
                WHERE a.staff_id LIKE '%".$_POST['find']."%' OR
