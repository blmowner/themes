<?php
    ...
    if($_POST['submit'] <> "") {
		...
		{
			$validpwd = TRUE;
			$msg = "INVALID Character detected";
		}
		else
		{
    ...
    <div class="banner_left">
        <div class="banner_right">
            <div class="banner_rightContent">
                <div class="title"><img src="theme/images/title.png">
				</div>
    <div id="login">
        <?php
            if ($validpwd) 
		...
		?>
					...
					<h2><?php echo load_lang('frame_name'); ?></h2>
                        <input type="text" name="username" placeholder="Student / Staff Id"/>
                        <input type="password" name="password" placeholder="Password"/>
                        <input type="submit" name="submit" value="<?php echo load_lang('login'); ?>"/>
