...
class mysql_base {
	...
	/*$dbx = new mysql_base();
	$dbx->Database = "demopostgrad";
	$dbx->User     = "root";
	$dbx->Password = "ptplsvc@1122mvcsql";
...
/* public: walk result set */
  ...
  public function halt($msg) {
    ...
    if ($this->Halt_On_Error != "report")
      die("<font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Session halted.</font>");
  }
  ...
  public function haltmsg($msg) 
  {
	...
	//$adminEmail = "mohd_nizam@msu.edu.my";
	...
	$adminEmail =$this->f('const_value');
  	...
  	$contact = "Opps! The function is not working as desired, please email to administrator ".$adminEmail." the following detail for rectification.<br>";
	$contact2 = "1) <b>Error detail</b> - ".$error."</pre><br>
				2) <b>Date & time of error</b> - ".$curdatetime."<br>
				3) <b>Source of error</b> - ".$location; //&#160;&#160;&#160;&#160;&#160;&#160;
	$detail = "";			
	$table = "<table style =\"table-layout: auto;\">
						<tr> 
						  <td ><strong><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Application Error</font></strong></td>
						  <td ><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">".$contact."</font></td>
						</tr>
						<tr> 
						  <td><strong><font size=\"2\" color=\"#FFFFFF\" face=\"Verdana, Arial, Helvetica, sans-serif\">&nbsp;</font></strong></td>
						  <td><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">".$contact2."</font></td>
						</tr>
    ...
    printf("%s<br>\n",$table);
	//printf("<b>Date Time</b>: %s<br>\n",$curdatetime);
	//printf("</td></tr></table><b>Database error:</b> %s<br>\n", $msg);
    //printf("<b>MySQL Error</b>: %s (%s)<br>\n",$this->Errno,$this->Error);
	
	 	include("../../../app/application/email/email_error.php");
  }
