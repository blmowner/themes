...
class PDF_MC_Table_disposal_all extends FPDF
{
var $widths;
var $aligns;
...
function Header()
	{
		...
		$this->Cell(0,6,"ASSET DISPOSAL REPORT ".date("Y"),0,1,"C"); // Title
		$this->Ln(6); 
		
	$varColList=array("No"=>array("width"=>6,"fieldNm"=>""),
					"Disposal ID "=>array("width"=>18,"fieldNm"=>"disposal_cd"),
						...
						"Price"=>array("width"=>13,"fieldNm"=>"purchasePrice"),
						"Purchase Date"=>array("width"=>22,"fieldNm"=>"datePurchase"),
						"Dispose Date"=>array("width"=>22,"fieldNm"=>"dateDispose"),	
			            "Method"=>array("width"=>15,"fieldNm"=>"description_disposal"),
						"Reason"=>array("width"=>20,"fieldNm"=>"remark"),
					);
