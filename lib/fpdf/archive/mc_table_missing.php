...
class PDF_MC_Table_missing extends FPDF
{
var $widths;
var $aligns;
...
function Header()
	{
		...
		$varColList=array("No"=>array("width"=>6,"fieldNm"=>""),
			"Asset ID "=>array("width"=>21,"fieldNm"=>"asset_id"),		
						...
						"Status"=>array("width"=>11,"fieldNm"=>"status"),	
						"Status 1"=>array("width"=>22,"fieldNm"=>"description_missing"),);
