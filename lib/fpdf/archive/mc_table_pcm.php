...
class PDF_MC_Table_pcm extends FPDF
{
var $widths;
var $aligns;
...
function Header()
	{
		$this->Image("../../theme/images/msuLogo.gif",10,10,30); // Logo
		//$this->Image("../../theme/images/msuLogo.gif",10,9,30); // Logo
		$this->Ln(10);
		$this->SetFont('Arial','B',6); // Arial bold 15
		...
		//$this->Ln(); 
		//$this->Cell(180,3,"Date Printed: ".date("F j, Y, h:i A"),0,0,"R"); // Move to the right
		//$this->Ln(); 
		//$this->Cell(180,3,"Printed By: ".$_SESSION['user_id'],0,0,"R"); // Move to the right
		$this->Ln(); 
		...
		$this->Cell(0,10,"PURCHASE APPROVAL - MAINTENANCE & DEV.",0,0,'C'); // Title
		$this->Ln(5);
	...
	function Footer()
	{
		...
		$this->Ln();
		//$this->Cell(0,10,'Page '.$this->PageNo().'/{nb}',0,0,'C');// Page number with total pages
