...
class PDF_MC_Table_souvenir_all extends FPDF
{
var $widths;
var $aligns;
...
function Header()
	{
		...
		$this->Cell(0,6,"SOUVENIR REQUISITION RECORD ".date("Y"),0,1,"C"); // Title
		$this->Ln(6); 
		
	$varColList=array("No"=>array("width"=>6,"fieldNm"=>""),
					"Souvenir ID "=>array("width"=>20,"fieldNm"=>"souvenir_cd"),
					"Department "=>array("width"=>40,"fieldNm"=>"descriptions"),
					"Unit Department "=>array("width"=>40,"fieldNm"=>"description"),
					"Request By "=>array("width"=>50,"fieldNm"=>"request_by"),
					"Date Purchase "=>array("width"=>20,"fieldNm"=>"dateSouvenir"),
					"Product Description"=>array("width"=>33,"fieldNm"=>"category_desc"),
					"Quantity"=>array("width"=>10,"fieldNm"=>"quantity"),
					"Total Budget"=>array("width"=>20,"fieldNm"=>"grand_total"),
