...
<script src="lib/js/colorbox/jquery.colorbox.js"></script>
</head>
...
function iframecode(url, w, h) {
				...
				$(".forgot_pwd").colorbox({href: "forgot_pwd.php",iframe:true, transition:"fade", width:"76%", height:"48%", closeButton:true});
			}
            ...
            <div class="banner_rightContent">
                ...
                <div id="login">
                    ...
                    <form method="post">
                        ...
                        <a class="forgot_pwd" onclick="iframecode('forgot_pwd.php','65.2%','53.2%')" href="#"  id = "forgot1" name = "forgot1">Forgot Your Password?</a>
                    </form>
                 </div>
            </div>
